...
Bpresupuesto::~Bpresupuesto(){
}

//Barra Scroll Vertical de la cabezera
void Bpresupuesto::ScrollCabeceraV(int valor)
{
...
void Bpresupuesto::ScrollCabeceraH(int valor)
{
...
/****************************************************************************************/
void Bpresupuesto::resizeEvent(QResizeEvent * evento)
{
