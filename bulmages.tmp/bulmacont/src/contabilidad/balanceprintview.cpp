        ...
        if (txt | html | kugar) {                // només continuem si hem pogut crear algun fitxer
            ...
            while (arbol->deshoja(nivel, superiores)) {
                ...
                if (txt) { //presentacion en txt normal
                    fitxersortidatxt << setiosflags(ios::left) << setw(10) <<  lcuenta.ascii() << " " << setw(40) <<  ldenominacion.left(40).ascii() << " " << resetiosflags(ios::left) << setw(12) <<  lsaldoant.ascii() << " " << setw(12) <<  ldebe.ascii() << " " << setw(12) <<  lhaber.ascii() << " " << setw(12) <<  lsaldo.ascii() << " " << setw(12) <<  ldebeej.ascii() << " " << setw(12) <<  lhaberej.ascii() << " " << setw(12) <<  lsaldoej.ascii() << " " << setw(12) <<  endl;
                }// end if
