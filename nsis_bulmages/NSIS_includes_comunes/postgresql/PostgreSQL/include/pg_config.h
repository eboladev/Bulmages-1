...
#define PACKAGE_STRING "PostgreSQL 8.4.5"

/* Define to the version of this package. */
#define PACKAGE_VERSION "8.4.5"

/* PostgreSQL version as a string */
#define PG_VERSION "8.4.5"
...
#define PG_VERSION_STR "PostgreSQL 8.4.5, compiled by Visual C++ build " __STRINGIFY2(_MSC_VER) ", 32-bit"
