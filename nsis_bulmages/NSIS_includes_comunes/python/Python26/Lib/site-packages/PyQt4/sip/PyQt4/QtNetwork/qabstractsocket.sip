// qabstractsocket.sip generated by MetaSIP on Thu Dec 22 09:25:28 2011
//
...
%ConvertToSubClassCode
    static struct class_graph {
        ...
        {sipName_QTcpServer, &sipType_QTcpServer, -1, 1},
    #if QT_VERSION >= 0x040400
        {sipName_QLocalSocket, &sipType_QLocalSocket, -1, 2},
    #else
        {0, 0, -1, 2},
    #endif
        {sipName_QHttp, &sipType_QHttp, -1, 3},
    #if QT_VERSION >= 0x040400
        {sipName_QNetworkCookieJar, &sipType_QNetworkCookieJar, -1, 4},
    #else
        {0, 0, -1, 4},
    #endif
        ...
        {sipName_QAbstractNetworkCache, &sipType_QAbstractNetworkCache, 13, 7},
    #else
        {0, 0, 13, 7},
    #endif
    #if QT_VERSION >= 0x040400
        {sipName_QNetworkAccessManager, &sipType_QNetworkAccessManager, -1, 8},
    #else
        {0, 0, -1, 8},
    #endif
        {sipName_QAbstractSocket, &sipType_QAbstractSocket, 14, 9},
    #if QT_VERSION >= 0x040400
        {sipName_QLocalServer, &sipType_QLocalServer, -1, 10},
    #else
        {0, 0, -1, 10},
    #endif
    #if QT_VERSION >= 0x040400
        {sipName_QNetworkReply, &sipType_QNetworkReply, -1, 11},
    #else
        {0, 0, -1, 11},
    #endif
        {sipName_QFtp, &sipType_QFtp, -1, 12},
    #if QT_VERSION >= 0x040700
        {sipName_QNetworkSession, &sipType_QNetworkSession, -1, -1},
    #else
        {0, 0, -1, -1},
    #endif
    #if QT_VERSION >= 0x040500
        ...
        {0, 0, -1, -1},
    #endif
        {sipName_QTcpSocket, &sipType_QTcpSocket, 16, 15},
