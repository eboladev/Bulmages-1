// qdir.sip generated by MetaSIP on Thu Dec 22 09:25:26 2011
//
...
%End
    ...
    QDir(const QString &path, const QString &nameFilter, QFlags<QDir::SortFlag> sort /DocValue="QDir.Name|QDir.IgnoreCase"/ = QDir::SortFlags(QDir::Name|QDir::IgnoreCase), QFlags<QDir::Filter> filters = TypeMask);
    ~QDir();
