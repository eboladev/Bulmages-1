...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>PyQt and Python v3 &mdash; PyQt 4.8.6 Reference Guide</title>
...
converted to and from a Python string.  In addition a <tt class="xref docutils literal"><span class="pre">None</span></tt> is converted to
...
Python string (and not <tt class="xref docutils literal"><span class="pre">None</span></tt>).  (This is because Qt often returns a null
...
<p><tt class="xref docutils literal"><span class="pre">None</span></tt> is interpreted as an invalid <tt class="docutils literal"><span class="pre">QVariant</span></tt> and vice versa.</p>
