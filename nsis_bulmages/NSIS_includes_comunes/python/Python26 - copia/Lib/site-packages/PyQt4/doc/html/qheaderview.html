...
<h3 class="fn"><a name="dataChanged" />QHeaderView.dataChanged (<i>self</i>, <a href="qmodelindex.html">QModelIndex</a>&#160;<i>topLeft</i>, <a href="qmodelindex.html">QModelIndex</a>&#160;<i>bottomRight</i>)</h3><h3 class="fn"><a name="defaultAlignment" /><a href="qt-alignment.html">Qt.Alignment</a> QHeaderView.defaultAlignment (<i>self</i>)</h3><h3 class="fn"><a name="defaultSectionSize" />int QHeaderView.defaultSectionSize (<i>self</i>)</h3><h3 class="fn"><a name="doItemsLayout" />QHeaderView.doItemsLayout (<i>self</i>)</h3><h3 class="fn"><a name="event" />bool QHeaderView.event (<i>self</i>, <a href="qevent.html">QEvent</a>&#160;<i>e</i>)</h3><p>Reimplemented from <a href="qobject.html#event">QObject.event</a>().</p>
