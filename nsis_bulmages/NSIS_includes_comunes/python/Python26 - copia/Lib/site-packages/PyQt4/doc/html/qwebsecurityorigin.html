...
<h3 class="fn"><a name="setDatabaseQuota" />QWebSecurityOrigin.setDatabaseQuota (<i>self</i>, int&#160;<i>quota</i>)</h3><p>Sets the quota for the databases in the security origin to
<i>quota</i> bytes.</p>
