...
<h3 class="fn"><a name="setMaximumCacheSize" />QNetworkDiskCache.setMaximumCacheSize (<i>self</i>, int&#160;<i>size</i>)</h3><p>Sets the maximum size of the disk cache to be <i>size</i>.</p>
