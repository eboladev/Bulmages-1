...
<h3 class="fn"><a name="field" /><a href="qsqlfield.html">QSqlField</a> QSqlRecord.field (<i>self</i>, int&#160;<i>i</i>)</h3><p>Returns the field at position <i>index</i>. If the position is
out of range, an empty field is returned.</p>
...
<h3 class="fn"><a name="__eq__" />bool QSqlRecord.__eq__ (<i>self</i>, <a href="qsqlrecord.html">QSqlRecord</a>&#160;<i>other</i>)</h3><h3 class="fn"><a name="__len__" /> QSqlRecord.__len__ (<i>self</i>)</h3><h3 class="fn"><a name="__ne__" />bool QSqlRecord.__ne__ (<i>self</i>, <a href="qsqlrecord.html">QSqlRecord</a>&#160;<i>other</i>)</h3><address><hr /><div align="center"><table border="0" cellspacing="0" width="100%"><tr class="address"><td align="left" width="25%">PyQt&#160;4.8.6 for Windows</td><td align="center" width="50%">Copyright &#169; <a href="http://www.riverbankcomputing.com">Riverbank&#160;Computing&#160;Ltd</a> and <a href="http://www.qtsoftware.com">Nokia</a> 2011</td><td align="right" width="25%">Qt&#160;4.7.4</td></tr></table></div></address></body></html>