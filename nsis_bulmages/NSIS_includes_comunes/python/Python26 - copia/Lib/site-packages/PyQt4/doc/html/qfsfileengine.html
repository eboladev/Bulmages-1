...
<h3 class="fn"><a name="open-2" />bool QFSFileEngine.open (<i>self</i>, <a href="qiodevice-openmode.html">QIODevice.OpenMode</a>&#160;<i>flags</i>, int&#160;<i>fd</i>)</h3><p>Opens the file handle <i>fh</i> in <i>openMode</i> mode. Returns
