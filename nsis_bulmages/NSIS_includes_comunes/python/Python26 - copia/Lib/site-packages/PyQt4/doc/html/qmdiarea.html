...
<td><img src="images/mdi-cascade.png" /></td>
<td><img src="images/mdi-tile.png" /></td>
</tr>
</table>
...
<h3 class="fn"><a name="setTabPosition" />QMdiArea.setTabPosition (<i>self</i>, <a href="qtabwidget.html#TabPosition-enum">QTabWidget.TabPosition</a>&#160;<i>position</i>)</h3><h3 class="fn"><a name="setTabShape" />QMdiArea.setTabShape (<i>self</i>, <a href="qtabwidget.html#TabShape-enum">QTabWidget.TabShape</a>&#160;<i>shape</i>)</h3><h3 class="fn"><a name="setupViewport" />QMdiArea.setupViewport (<i>self</i>, <a href="qwidget.html">QWidget</a>&#160;<i>viewport</i>)</h3><p>This slot is called by <a href="qabstractscrollarea.html">QAbstractScrollArea</a> after <a href="qabstractscrollarea.html#setViewport">setViewport</a>() has been
...
<h3 class="fn"><a name="tabPosition" /><a href="qtabwidget.html#TabPosition-enum">QTabWidget.TabPosition</a> QMdiArea.tabPosition (<i>self</i>)</h3><h3 class="fn"><a name="tabShape" /><a href="qtabwidget.html#TabShape-enum">QTabWidget.TabShape</a> QMdiArea.tabShape (<i>self</i>)</h3><h3 class="fn"><a name="testOption" />bool QMdiArea.testOption (<i>self</i>, <a href="qmdiarea.html#AreaOption-enum">AreaOption</a>&#160;<i>opton</i>)</h3><p>Returns true if <i>option</i> is enabled; otherwise returns
false.</p>
