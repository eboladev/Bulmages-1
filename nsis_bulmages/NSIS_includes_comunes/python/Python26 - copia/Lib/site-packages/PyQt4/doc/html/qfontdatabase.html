...
<h3 class="fn"><a name="pointSizes" />list-of-int QFontDatabase.pointSizes (<i>self</i>, QString&#160;<i>family</i>, QString&#160;<i>style</i>&#160;=&#160;QString())</h3><p>Returns a list of the point sizes available for the font that
has family <i>family</i> and style <i>style</i>. The list may be
empty.</p>
...
<h3 class="fn"><a name="smoothSizes" />list-of-int QFontDatabase.smoothSizes (<i>self</i>, QString&#160;<i>family</i>, QString&#160;<i>style</i>)</h3><p>Returns the point sizes of a font that has family <i>family</i>
and style <i>style</i> that will look attractive. The list may be
empty. For non-scalable fonts and bitmap scalable fonts, this
function is equivalent to <a href="qfontdatabase.html#pointSizes">pointSizes</a>().</p>
