...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>PyQt Reference Guide &mdash; PyQt 4.8.6 Reference Guide</title>
    ...
    <link rel="top" title="PyQt 4.8.6 Reference Guide" href="#" />
  ...
  <body>
    <div class="related">
      ...
      <ul>
        ...
        <li><a href="#">PyQt 4.8.6 Reference Guide</a> &raquo;</li> 
      </ul>
    </div>  
...
<li class="toctree-l2"><a class="reference internal" href="introduction.html#pyqt-components">PyQt Components</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="incompatibilities.html#pyqt-v4-8-3">PyQt v4.8.3</a></li>
<li class="toctree-l2"><a class="reference internal" href="incompatibilities.html#pyqt-v4-8">PyQt v4.8</a></li>
<li class="toctree-l2"><a class="reference internal" href="incompatibilities.html#pyqt-v4-7-4">PyQt v4.7.4</a></li>
<li class="toctree-l2"><a class="reference internal" href="incompatibilities.html#pyqt-v4-7-1">PyQt v4.7.1</a></li>
<li class="toctree-l2"><a class="reference internal" href="incompatibilities.html#pyqt-v4-5">PyQt v4.5</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="installation.html">Installing PyQt</a><ul>
<li class="toctree-l2"><a class="reference internal" href="installation.html#downloading-sip">Downloading SIP</a></li>
<li class="toctree-l2"><a class="reference internal" href="installation.html#downloading-pyqt">Downloading PyQt</a></li>
<li class="toctree-l2"><a class="reference internal" href="installation.html#configuring-pyqt">Configuring PyQt</a></li>
<li class="toctree-l2"><a class="reference internal" href="installation.html#configuring-sip-and-pyqt-for-macos">Configuring SIP and PyQt for MacOS</a></li>
<li class="toctree-l2"><a class="reference internal" href="installation.html#building-pyqt">Building PyQt</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="python_v3.html">PyQt and Python v3</a><ul>
...
<li class="toctree-l2"><a class="reference internal" href="new_style_signals_slots.html#defining-new-signals-with-pyqtsignal">Defining New Signals with <tt class="docutils literal"><span class="pre">pyqtSignal()</span></tt></a></li>
...
<li class="toctree-l2"><a class="reference internal" href="new_style_signals_slots.html#the-pyqtslot-decorator">The <tt class="docutils literal"><span class="pre">pyqtSlot()</span></tt> Decorator</a></li>
...
<li class="toctree-l2"><a class="reference internal" href="old_style_signals_slots.html#pyqt-signals-and-qt-signals">PyQt Signals and Qt Signals</a></li>
<li class="toctree-l2"><a class="reference internal" href="old_style_signals_slots.html#the-pyqt-pyobject-signal-argument-type">The <tt class="docutils literal"><span class="pre">PyQt_PyObject</span></tt> Signal Argument Type</a></li>
...
<li class="toctree-l2"><a class="reference internal" href="old_style_signals_slots.html#pyqt-slots-and-qt-slots">PyQt Slots and Qt Slots</a></li>
...
<li class="toctree-l2"><a class="reference internal" href="old_style_signals_slots.html#the-qtcore-pyqtsignature-decorator">The <tt class="docutils literal"><span class="pre">QtCore.pyqtSignature()</span></tt> Decorator</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="gotchas.html#none-and-null"><tt class="xref docutils literal"><span class="pre">None</span></tt> and <tt class="docutils literal"><span class="pre">NULL</span></tt></a></li>
<li class="toctree-l2"><a class="reference internal" href="gotchas.html#support-for-void">Support for <tt class="docutils literal"><span class="pre">void</span> <span class="pre">*</span></tt></a></li>
<li class="toctree-l2"><a class="reference internal" href="gotchas.html#super-and-pyqt-classes"><tt class="docutils literal"><span class="pre">super</span></tt> and PyQt Classes</a></li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="designer.html#the-uic-module">The <tt class="docutils literal"><span class="pre">uic</span></tt> Module</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="resources.html">The PyQt Resource System</a><ul>
<li class="toctree-l2"><a class="reference internal" href="resources.html#pyrcc4"><strong class="program">pyrcc4</strong></a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="qvariant.html">Python Objects and QVariant</a></li>
<li class="toctree-l1"><a class="reference internal" href="qsettings.html">Support for QSettings</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="python_shell.html">Using PyQt from the Python Shell</a></li>
<li class="toctree-l1"><a class="reference internal" href="i18n.html">Internationalisation of PyQt Applications</a><ul>
<li class="toctree-l2"><a class="reference internal" href="i18n.html#pylupdate4"><strong class="program">pylupdate4</strong></a></li>
<li class="toctree-l2"><a class="reference internal" href="i18n.html#differences-between-pyqt-and-qt">Differences Between PyQt and Qt</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="dbus.html">The DBus Support Module</a></li>
<li class="toctree-l1"><a class="reference internal" href="incompatible_apis.html">Selecting Incompatible APIs</a></li>
<li class="toctree-l1"><a class="reference internal" href="deploy_commercial.html">Deploying Commercial PyQt Applications</a></li>
<li class="toctree-l1"><a class="reference internal" href="build_system.html">The PyQt Build System</a></li>
</ul>
</div>
</div>
