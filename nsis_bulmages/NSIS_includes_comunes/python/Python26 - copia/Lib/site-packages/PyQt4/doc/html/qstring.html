...
<pre class="cpp">
     <span class="preprocessor">#define QT_USE_FAST_CONCATENATION</span>
</pre>
<p>and use <tt>'%'</tt> instead of <tt>'+'</tt> for string
concatenation everywhere. The third approach, which is the most
convenient but not entirely source compatible, is to include two
defines:</p>
<pre class="cpp">
     <span class="preprocessor">#define QT_USE_FAST_CONCATENATION</span>
     <span class="preprocessor">#define QT_USE_FAST_OPERATOR_PLUS</span>
</pre>
...
<h3 class="fn"><a name="contains-2" />bool QString.contains (<i>self</i>, <a href="qregexp.html">QRegExp</a>&#160;<i>rx</i>)</h3><h3 class="fn"><a name="count" />int QString.count (<i>self</i>)</h3><p>Returns the number of (potentially overlapping) occurrences of
...
<h3 class="fn"><a name="endsWith-2" />bool QString.endsWith (<i>self</i>, <a href="qlatin1string.html">QLatin1String</a>&#160;<i>s</i>, <a href="qt.html#CaseSensitivity-enum">Qt.CaseSensitivity</a>&#160;<i>cs</i>&#160;=&#160;Qt.CaseSensitive)</h3><h3 class="fn"><a name="fill" />QString QString.fill (<i>self</i>, QChar&#160;<i>ch</i>, int&#160;<i>size</i>&#160;=&#160;-1)</h3><p>Sets every character in the string to character <i>ch</i>. If
...
<h3 class="fn"><a name="indexOf-2" />int QString.indexOf (<i>self</i>, <a href="qlatin1string.html">QLatin1String</a>&#160;<i>str</i>, int&#160;<i>from</i>&#160;=&#160;0, <a href="qt.html#CaseSensitivity-enum">Qt.CaseSensitivity</a>&#160;<i>cs</i>&#160;=&#160;Qt.CaseSensitive)</h3><p>Returns the index position of the first occurrence of the string
<i>str</i> in this string, searching forward from index position
<i>from</i>. Returns -1 if <i>str</i> is not found.</p>
<p>If <i>cs</i> is <a href="qt.html#CaseSensitivity-enum">Qt.CaseSensitive</a> (default), the
search is case sensitive; otherwise the search is case
...
<h3 class="fn"><a name="indexOf-3" />int QString.indexOf (<i>self</i>, <a href="qregexp.html">QRegExp</a>&#160;<i>rx</i>, int&#160;<i>from</i>&#160;=&#160;0)</h3><p>This function overloads <a href="qstring.html#indexOf">indexOf</a>().</p>
...
<h3 class="fn"><a name="lastIndexOf-2" />int QString.lastIndexOf (<i>self</i>, <a href="qlatin1string.html">QLatin1String</a>&#160;<i>str</i>, int&#160;<i>from</i>&#160;=&#160;-1, <a href="qt.html#CaseSensitivity-enum">Qt.CaseSensitivity</a>&#160;<i>cs</i>&#160;=&#160;Qt.CaseSensitive)</h3><p>Returns the index position of the last occurrence of the string
<i>str</i> in this string, searching backward from index position
<i>from</i>. If <i>from</i> is -1 (default), the search starts at
the last character; if <i>from</i> is -2, at the next to last
character and so on. Returns -1 if <i>str</i> is not found.</p>
...
<h3 class="fn"><a name="lastIndexOf-3" />int QString.lastIndexOf (<i>self</i>, <a href="qregexp.html">QRegExp</a>&#160;<i>rx</i>, int&#160;<i>from</i>&#160;=&#160;-1)</h3><p>This function overloads <a href="qstring.html#lastIndexOf">lastIndexOf</a>().</p>
...
<h3 class="fn"><a name="startsWith-2" />bool QString.startsWith (<i>self</i>, <a href="qlatin1string.html">QLatin1String</a>&#160;<i>s</i>, <a href="qt.html#CaseSensitivity-enum">Qt.CaseSensitivity</a>&#160;<i>cs</i>&#160;=&#160;Qt.CaseSensitive)</h3><h3 class="fn"><a name="toAscii" /><a href="qbytearray.html">QByteArray</a> QString.toAscii (<i>self</i>)</h3><p>Returns an 8-bit representation of the string as a <a href="qbytearray.html">QByteArray</a>.</p>
...
<p><b>See also</b> <a href="qstring.html#toUpper">toUpper</a>().</p>
...
<p><b>See also</b> <a href="qstring.html#toLower">toLower</a>().</p>
