...
<h3 class="fn"><a name="FindFlag-enum" />QWebPage.FindFlag</h3><p>This enum describes the options available to the <a href="qwebpage.html#findText">findText</a>() function. The options can
...
<h3 class="fn"><a name="WebAction-enum" />QWebPage.WebAction</h3><p>This enum describes the types of action which can be performed
on the web page.</p>
...
<h3 class="fn"><a name="history" /><a href="qwebhistory.html">QWebHistory</a> QWebPage.history (<i>self</i>)</h3><p>Returns a pointer to the view's history of navigated web
pages.</p>
...
<p>"Mozilla/5.0 (%Platform%; %Security%; %Subplatform%; %Locale%)
...
run-time:</p>
<ul>
<li>%Platform% and %Subplatform% are expanded to the windowing
system and the operation system.</li>
<li>%Security% expands to U if SSL is enabled, otherwise N. SSL is
enabled if <a href="qsslsocket.html#supportsSsl">QSslSocket.supportsSsl</a>() returns
true.</li>
<li>%Locale% is replaced with <a href="qlocale.html#name">QLocale.name</a>(). The locale is determined
from the view of the <a href="qwebpage.html">QWebPage</a>. If no
view is set on the <a href="qwebpage.html">QWebPage</a>, then a
default constructed <a href="qlocale.html">QLocale</a> is used
instead.</li>
...
<h3 class="fn"><a name="viewportSize" /><a href="qsize.html">QSize</a> QWebPage.viewportSize (<i>self</i>)</h3><hr /><h2>Qt Signal Documentation</h2><h3 class="fn"><a name="contentsChanged" />void contentsChanged ()</h3><p>This is the default overload of this signal.</p><p>This signal is emitted whenever the text in form elements
...
<h3 class="fn"><a name="frameCreated" />void frameCreated (QWebFrame *)</h3><p>This is the default overload of this signal.</p><p>This signal is emitted whenever the page creates a new
<i>frame</i>.</p>
<p><b>See also</b> <a href="qwebpage.html#currentFrame">currentFrame</a>().</p>
...
<h3 class="fn"><a name="repaintRequested" />void repaintRequested (const QRect&amp;)</h3><p>This is the default overload of this signal.</p><p>This signal is emitted whenever this <a href="qwebpage.html">QWebPage</a> should be updated and no view was set.
<i>dirtyRect</i> contains the area that needs to be updated. To
paint the <a href="qwebpage.html">QWebPage</a> get the <a href="qwebpage.html#mainFrame">mainFrame</a>() and call the
