...
<p>Instead, you can use the <a href="qvariant.html#value">QVariant.value</a>() or the <a href="qvariant.html#qVariantValue">qVariantValue</a>() template
...
<pre class="cpp">
 ...
 <span class="comment">// group: ["fridge"]</span>
</pre>
