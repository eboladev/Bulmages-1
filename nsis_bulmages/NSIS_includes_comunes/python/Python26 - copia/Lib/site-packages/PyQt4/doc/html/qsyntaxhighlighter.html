...
<h3 class="fn"><a name="setCurrentBlockUserData" />QSyntaxHighlighter.setCurrentBlockUserData (<i>self</i>, <a href="qtextblockuserdata.html">QTextBlockUserData</a>&#160;<i>data</i>)</h3><p>The <i>data</i> argument has it's ownership transferred to Qt.</p><p>Attaches the given <i>data</i> to the current text block. The
