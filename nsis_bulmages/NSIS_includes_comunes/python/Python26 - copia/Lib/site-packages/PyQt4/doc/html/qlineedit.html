...
<h3 class="fn"><a name="cursorPosition" />int QLineEdit.cursorPosition (<i>self</i>)</h3><h3 class="fn"><a name="cursorPositionAt" />int QLineEdit.cursorPositionAt (<i>self</i>, <a href="qpoint.html">QPoint</a>&#160;<i>pos</i>)</h3><p>Returns the cursor position under the point <i>pos</i>.</p>
...
<i>text</i> argument is the next text.</p>
