...
<h3 class="fn"><a name="key" />QString QSharedMemory.key (<i>self</i>)</h3><p>Returns the key assigned to this shared memory. The key is the
identifier used by the operating system to identify the shared
memory segment. When <a href="qsharedmemory.html">QSharedMemory</a>
is used for interprocess communication, the key is how each process
attaches to the shared memory segment through which the IPC
occurs.</p>
<p><b>See also</b> <a href="qsharedmemory.html#setKey">setKey</a>().</p>
...
<p><b>See also</b> <a href="qsharedmemory.html#key">key</a>() and
