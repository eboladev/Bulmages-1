...
<h3 class="fn"><a name="QNetworkProxyFactory-2" />QNetworkProxyFactory.__init__ (<i>self</i>, <a href="qnetworkproxyfactory.html">QNetworkProxyFactory</a>)</h3><h3 class="fn"><a name="proxyForQuery" />list-of-QNetworkProxy QNetworkProxyFactory.proxyForQuery (<a href="qnetworkproxyquery.html">QNetworkProxyQuery</a>&#160;<i>query</i>)</h3><p>This function examines takes the query request, <i>query</i>,
examines the details of the type of socket or request and returns a
list of <a href="qnetworkproxy.html">QNetworkProxy</a> objects that
indicate the proxy servers to be used, in order of preference.</p>


<h3 class="fn"><a name="queryProxy" />list-of-QNetworkProxy QNetworkProxyFactory.queryProxy (<i>self</i>, <a href="qnetworkproxyquery.html">QNetworkProxyQuery</a>&#160;<i>query</i>&#160;=&#160;QNetworkProxyQuery())</h3><p>This method is abstract and should be reimplemented in any sub-class.</p><p>This function examines takes the query request, <i>query</i>,
examines the details of the type of socket or request and returns a
list of <a href="qnetworkproxy.html">QNetworkProxy</a> objects that
indicate the proxy servers to be used, in order of preference.</p>
...
<h3 class="fn"><a name="systemProxyForQuery" />list-of-QNetworkProxy QNetworkProxyFactory.systemProxyForQuery (<a href="qnetworkproxyquery.html">QNetworkProxyQuery</a>&#160;<i>query</i>&#160;=&#160;QNetworkProxyQuery())</h3><p>This function examines takes the query request, <i>query</i>,
examines the details of the type of socket or request and returns a
list of <a href="qnetworkproxy.html">QNetworkProxy</a> objects that
indicate the proxy servers to be used, in order of preference.</p>
...
queries.</p>
<p>On other systems, there is no standardised method of obtaining
the system proxy configuration. This function may be improved in
future versions to support those systems.</p>
