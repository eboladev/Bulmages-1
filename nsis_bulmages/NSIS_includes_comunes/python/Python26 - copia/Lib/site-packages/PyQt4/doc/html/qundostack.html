...
<p>If <i>prefix</i> is empty, the default prefix "Redo" is
used.</p>
...
this action will be disabled.</p>
<p>If <i>prefix</i> is empty, the default prefix "Undo" is
used.</p>
...
<p><b>See also</b> <a href="qundocommand.html#text">QUndoCommand.text</a>() and <a href="qundostack.html#undoText">undoText</a>().</p>
...
<p><b>See also</b> <a href="qundocommand.html#text">QUndoCommand.text</a>() and <a href="qundostack.html#redoText">redoText</a>().</p>
