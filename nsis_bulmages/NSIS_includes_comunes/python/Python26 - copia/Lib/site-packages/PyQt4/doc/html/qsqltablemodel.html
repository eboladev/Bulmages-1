...
<pre class="cpp">
     ...
     model<span class="operator">-</span><span class="operator">&gt;</span>removeColumn(<span class="number">0</span>); <span class="comment">// don't show the ID</span>
...
<h3 class="fn"><a name="fieldIndex" />int QSqlTableModel.fieldIndex (<i>self</i>, QString&#160;<i>fieldName</i>)</h3><p>Returns the index of the field <i>fieldName</i>.</p>
