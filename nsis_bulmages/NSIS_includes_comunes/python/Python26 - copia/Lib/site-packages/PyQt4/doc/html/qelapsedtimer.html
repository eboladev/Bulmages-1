...
This clock type is used on Windows and Symbian platforms.</p>
...
<h3 class="fn"><a name="isValid" />bool QElapsedTimer.isValid (<i>self</i>)</h3><p>Returns true if this object was invalidated by a call to
