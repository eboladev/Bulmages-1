...
<tt>toColor()</tt> function. Instead, you can use the <a href="qvariant.html#value">QVariant.value</a>() or the <a href="qvariant.html#qVariantValue">qVariantValue</a>() template
...
stored.</p>
<p>Usually, you never have to use this constructor, use <a href="qvariant.html#qVariantFromValue">qVariantFromValue</a>() instead
to construct variants from the pointer types represented by
<tt>QMetaType.VoidStar</tt>, <tt>QMetaType.QObjectStar</tt> and
<tt>QMetaType.QWidgetStar</tt>.</p>
<p><b>See also</b> <a href="qvariant.html#qVariantFromValue">qVariantFromValue</a>() and
<a href="qvariant.html#Type-enum">Type</a>.</p>
...
<h3 class="fn"><a name="save" />QVariant.save (<i>self</i>, <a href="qdatastream.html">QDataStream</a>&#160;<i>ds</i>)</h3><h3 class="fn"><a name="toBitArray" /><a href="qbitarray.html">QBitArray</a> QVariant.toBitArray (<i>self</i>)</h3><p>Returns the variant as a <a href="qbitarray.html">QBitArray</a>
...
<h3 class="fn"><a name="__eq__" />bool QVariant.__eq__ (<i>self</i>, QVariant&#160;<i>v</i>)</h3><h3 class="fn"><a name="__ne__" />bool QVariant.__ne__ (<i>self</i>, QVariant&#160;<i>v</i>)</h3><address><hr /><div align="center"><table border="0" cellspacing="0" width="100%"><tr class="address"><td align="left" width="25%">PyQt&#160;4.8.6 for Windows</td><td align="center" width="50%">Copyright &#169; <a href="http://www.riverbankcomputing.com">Riverbank&#160;Computing&#160;Ltd</a> and <a href="http://www.qtsoftware.com">Nokia</a> 2011</td><td align="right" width="25%">Qt&#160;4.7.4</td></tr></table></div></address></body></html>