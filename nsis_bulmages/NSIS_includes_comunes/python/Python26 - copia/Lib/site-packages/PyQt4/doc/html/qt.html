...
<p class="centerAlign"><img src="images/qimage-scaling.png" /></p>
<table class="valuelist">
<tr class="odd" valign="top">
<th class="tblConst">Constant</th>
<th class="tblval">Value</th>
...
<a href="qobject.html#connect">QObject.connect</a>(), and <a href="qmetatype.html#qRegisterMetaType">qRegisterMetaType</a>().</p>
...
<td class="topAlign"><tt>0</tt></td>
<td class="topAlign"><img src="images/cursor-arrow.png" /> The
standard arrow cursor.</td>
</tr>
<tr>
<td class="topAlign"><tt>Qt.UpArrowCursor</tt></td>
<td class="topAlign"><tt>1</tt></td>
<td class="topAlign"><img src="images/cursor-uparrow.png" /> An
arrow pointing upwards toward the top of the screen.</td>
</tr>
<tr>
<td class="topAlign"><tt>Qt.CrossCursor</tt></td>
<td class="topAlign"><tt>2</tt></td>
<td class="topAlign"><img src="images/cursor-cross.png" /> A
...
<td class="topAlign"><tt>3</tt></td>
<td class="topAlign"><img src="images/cursor-wait.png" /> An
...
<td class="topAlign"><tt>4</tt></td>
<td class="topAlign"><img src="images/cursor-ibeam.png" /> A caret
or ibeam cursor, indicating that a widget can accept and display
text input.</td>
</tr>
<tr>
<td class="topAlign"><tt>Qt.SizeVerCursor</tt></td>
<td class="topAlign"><tt>5</tt></td>
<td class="topAlign"><img src="images/cursor-sizev.png" /> A cursor
used for elements that are used to vertically resize top-level
windows.</td>
</tr>
<tr>
<td class="topAlign"><tt>Qt.SizeHorCursor</tt></td>
<td class="topAlign"><tt>6</tt></td>
<td class="topAlign"><img src="images/cursor-sizeh.png" /> A cursor
used for elements that are used to horizontally resize top-level
windows.</td>
</tr>
<tr>
<td class="topAlign"><tt>Qt.SizeBDiagCursor</tt></td>
<td class="topAlign"><tt>7</tt></td>
<td class="topAlign"><img src="images/cursor-sizeb.png" /> A cursor
used for elements that are used to diagonally resize top-level
windows at their top-right and bottom-left corners.</td>
</tr>
<tr>
<td class="topAlign"><tt>Qt.SizeFDiagCursor</tt></td>
<td class="topAlign"><tt>8</tt></td>
<td class="topAlign"><img src="images/cursor-sizef.png" /> A cursor
used for elements that are used to diagonally resize top-level
windows at their top-left and bottom-right corners.</td>
</tr>
<tr>
<td class="topAlign"><tt>Qt.SizeAllCursor</tt></td>
<td class="topAlign"><tt>9</tt></td>
<td class="topAlign"><img src="images/cursor-sizeall.png" /> A
cursor used for elements that are used to resize top-level windows
in any direction.</td>
</tr>
<tr>
...
<td class="topAlign"><tt>11</tt></td>
<td class="topAlign"><img src="images/cursor-vsplit.png" /> A
cursor used for vertical splitters, indicating that a handle can be
dragged horizontally to adjust the use of available space.</td>
</tr>
<tr>
<td class="topAlign"><tt>Qt.SplitHCursor</tt></td>
<td class="topAlign"><tt>12</tt></td>
<td class="topAlign"><img src="images/cursor-hsplit.png" /> A
cursor used for horizontal splitters, indicating that a handle can
be dragged vertically to adjust the use of available space.</td>
</tr>
<tr>
<td class="topAlign"><tt>Qt.PointingHandCursor</tt></td>
<td class="topAlign"><tt>13</tt></td>
<td class="topAlign"><img src="images/cursor-hand.png" /> A
...
<td class="topAlign"><tt>14</tt></td>
<td class="topAlign"><img src="images/cursor-forbidden.png" /> A
slashed circle cursor, typically used during drag and drop
...
<td class="topAlign"><tt>17</tt></td>
<td class="topAlign"><img src="images/cursor-openhand.png" /> A
cursor representing an open hand, typically used to indicate that
the area under the cursor is the visible part of a canvas that the
user can click and drag in order to scroll around.</td>
</tr>
<tr>
<td class="topAlign"><tt>Qt.ClosedHandCursor</tt></td>
<td class="topAlign"><tt>18</tt></td>
<td class="topAlign"><img src="images/cursor-closedhand.png" /> A
cursor representing a closed hand, typically used to indicate that
a dragging operation is in progress that involves scrolling.</td>
</tr>
<tr>
<td class="topAlign"><tt>Qt.WhatsThisCursor</tt></td>
<td class="topAlign"><tt>15</tt></td>
<td class="topAlign"><img src="images/cursor-whatsthis.png" /> An
arrow with a question mark, typically used to indicate the presence
of What's This? help for a widget.</td>
</tr>
<tr>
...
<p>When LayoutDirectoinAuto is used in conjunction with text
...
(e.g., "<a href="http://bugreports.qt.nokia.com/browse/QTWEBSITE-13">http://bugreports.qt.../QTWEBSITE-13/</a>"),
