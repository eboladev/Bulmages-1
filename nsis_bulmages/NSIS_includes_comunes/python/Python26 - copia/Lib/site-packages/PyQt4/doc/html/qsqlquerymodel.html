...
<p>If the database doesn't return the amount of selected rows in a
...
<p>To force fetching of the entire database, you can use the
following:</p>
<pre class="cpp">
...
the amount of rows of the current query is returned. Otherwise,
returns the amount of rows currently cached on the client.</p>
<p><i>parent</i> should always be an invalid <a href="qmodelindex.html">QModelIndex</a>.</p>
<p>This function was introduced in Qt 4.1.</p>
