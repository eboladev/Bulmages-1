...
<tr>
<td class="topAlign"><tt>QScriptValue.QObjectMember</tt></td>
<td class="topAlign"><tt>0x00000020</tt></td>
<td class="topAlign">This flag is used to indicate that an existing
property is a <a href="qobject.html">QObject</a> member (a property
or method).</td>
</tr>
<tr>
...
<tr>
<td class="topAlign"><tt>QScriptValue.UserRange</tt></td>
<td class="topAlign"><tt>0xff000000</tt></td>
<td class="topAlign">Flags in this range are not used by Qt Script,
and can be used for custom purposes.</td>
</tr>
</table>
