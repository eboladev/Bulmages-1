...
<p class="centerAlign"><img src="images/effectwidget.png" /></p>
<p>Note that some audio effects do not have parameters, and the
widget will then not <a href="qwidget.html#show">show()</a> at
all.</p>
<hr /><h2>Method Documentation</h2><h3 class="fn"><a name="EffectWidget" />EffectWidget.__init__ (<i>self</i>, <a href="phonon-effect.html">Effect</a>&#160;<i>effect</i>, <a href="qwidget.html">QWidget</a>&#160;<i>parent</i>&#160;=&#160;None)</h3><p>The <i>parent</i> argument, if not None, causes <i>self</i> to be owned by Qt instead of PyQt.</p><address><hr /><div align="center"><table border="0" cellspacing="0" width="100%"><tr class="address"><td align="left" width="25%">PyQt&#160;4.8.6 for Windows</td><td align="center" width="50%">Copyright &#169; <a href="http://www.riverbankcomputing.com">Riverbank&#160;Computing&#160;Ltd</a> and <a href="http://www.qtsoftware.com">Nokia</a> 2011</td><td align="right" width="25%">Qt&#160;4.7.4</td></tr></table></div></address></body></html>