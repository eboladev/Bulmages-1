...
<pre class="cpp">
     ...
     verticalScrollBar()<span class="operator">-</span><span class="operator">&gt;</span>setPageStep(widgetSize<span class="operator">.</span>height());
     horizontalScrollBar()<span class="operator">-</span><span class="operator">&gt;</span>setPageStep(widgetSize<span class="operator">.</span>width());
