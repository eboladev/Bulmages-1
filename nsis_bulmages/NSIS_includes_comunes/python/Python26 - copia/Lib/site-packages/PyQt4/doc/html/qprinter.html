...
<h3 class="fn"><a name="devType" />int QPrinter.devType (<i>self</i>)</h3><h3 class="fn"><a name="docName" />QString QPrinter.docName (<i>self</i>)</h3><p>Returns the document name.</p>
