...
&quot;http://b&#252;hler.example.com&quot; would be sent to the server as
&quot;http://xn--bhler-kva.example.com/List%20of%20applicants.xml&quot;.</p>
...
characters that are not allowed in a URL.</p>
<p>Example:</p>
<pre class="cpp">
...
<h3 class="fn"><a name="QUrl-3" />QUrl.__init__ (<i>self</i>, <a href="qurl.html">QUrl</a>&#160;<i>copy</i>)</h3><p>Constructs a copy of <i>other</i>.</p>


<h3 class="fn"><a name="QUrl-4" />QUrl.__init__ (<i>self</i>, QString&#160;<i>url</i>, <a href="qurl.html#ParsingMode-enum">ParsingMode</a>&#160;<i>mode</i>)</h3><p>This is an overloaded function.</p>
<p>Parses the <i>url</i> using the parser mode
<i>parsingMode</i>.</p>
...
<i>localFile</i>, interpreted as a local file.</p>
<p><b>See also</b> <a href="qurl.html#toLocalFile">toLocalFile</a>().</p>
...
<a id="tips-to-avoid-erroneous-character-conversion-when-dealing-with" name="tips-to-avoid-erroneous-character-conversion-when-dealing-with" />
<h5>Tips to avoid erroneous character conversion when dealing
with</h5>
<p>URLs and strings:</p>
<ul>
<li>When creating an URL <a href="qstring.html">QString</a> from a
<a href="qbytearray.html">QByteArray</a> or a char*, always use
<a href="qstring.html#fromUtf8">QString.fromUtf8</a>().</li>
...
<p class="centerAlign"><img src="images/qurl-authority.png" /></p>
...
<p class="centerAlign"><img src="images/qurl-fragment.png" /></p>
...
'&amp;'.</p>
<p class="centerAlign"><img src="images/qurl-querystring.png" /></p>
...
the scheme is "ftp":</p>
<p class="centerAlign"><img src="images/qurl-authority2.png" /></p>
...
<p class="centerAlign"><img src="images/qurl-authority3.png" /></p>
...
<h3 class="fn"><a name="toLocalFile" />QString QUrl.toLocalFile (<i>self</i>)</h3><p>Returns the path of this URL formatted as a local file path.</p>
<p><b>See also</b> <a href="qurl.html#fromLocalFile">fromLocalFile</a>().</p>
