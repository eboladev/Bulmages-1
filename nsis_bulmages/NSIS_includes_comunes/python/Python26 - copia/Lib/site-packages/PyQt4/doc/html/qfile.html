...
<p><b>Note:</b> On Symbian, no link is created and false is
returned if <a href="qfile.html#fileName">fileName</a>() currently
specifies a directory.</p>
<p><b>See also</b> <a href="qfile.html#setFileName">setFileName</a>().</p>
...
<h3 class="fn"><a name="open-2" />bool QFile.open (<i>self</i>, int&#160;<i>fd</i>, <a href="qiodevice-openmode.html">QIODevice.OpenMode</a>&#160;<i>flags</i>)</h3><h3 class="fn"><a name="permissions" /><a href="qfile-permissions.html">Permissions</a> QFile.permissions (<i>self</i>)</h3><p>Returns the complete OR-ed together combination of <a href="qfile.html#Permission-enum">QFile.Permission</a> for the
file.</p>
