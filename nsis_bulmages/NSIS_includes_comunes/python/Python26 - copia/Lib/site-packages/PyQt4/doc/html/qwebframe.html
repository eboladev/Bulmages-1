...
<hr /><h2>Method Documentation</h2><h3 class="fn"><a name="addToJavaScriptWindowObject" />QWebFrame.addToJavaScriptWindowObject (<i>self</i>, QString&#160;<i>name</i>, <a href="qobject.html">QObject</a>&#160;<i>object</i>)</h3><p>The <i>object</i> argument has it's ownership transferred to Qt.</p><p>Make <i>object</i> available under <i>name</i> from within the
...
history for the frame.</p>
<p><b>See also</b> <a href="qwebframe.html#toHtml">toHtml</a>() and
<a href="qwebframe.html#setContent">setContent</a>().</p>
...
<h3 class="fn"><a name="pageChanged" />void pageChanged ()</h3><p>This is the default overload of this signal.</p><h3 class="fn"><a name="titleChanged" />void titleChanged (const QString&amp;)</h3><p>This is the default overload of this signal.</p><p>This signal is emitted whenever the title of the frame changes.
