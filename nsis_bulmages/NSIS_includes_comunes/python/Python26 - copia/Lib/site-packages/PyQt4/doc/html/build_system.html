...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>The PyQt Build System &mdash; PyQt 4.8.6 Reference Guide</title>
...
<tbody valign="top">
<tr class="field"><th class="field-name">Parameters:</th><td class="field-body"><strong>sub_cfg</strong> &#8211; an optional list of sub-class configurations.  It should only be used
