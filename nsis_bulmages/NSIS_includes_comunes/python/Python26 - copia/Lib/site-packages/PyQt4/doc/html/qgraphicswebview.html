...
<h3 class="fn"><a name="resizesToContents" />bool QGraphicsWebView.resizesToContents (<i>self</i>)</h3><h3 class="fn"><a name="sceneEvent" />bool QGraphicsWebView.sceneEvent (<i>self</i>, <a href="qevent.html">QEvent</a>)</h3><p>Reimplemented from <a href="qgraphicsitem.html#sceneEvent">QGraphicsItem.sceneEvent</a>().</p>
...
<p><b>See also</b> <a href="qgraphicswebview.html#load">load</a>(),
<a href="qgraphicswebview.html#setContent">setContent</a>(), and
<a href="qwebframe.html#toHtml">QWebFrame.toHtml</a>().</p>
...
<h3 class="fn"><a name="setResizesToContents" />QGraphicsWebView.setResizesToContents (<i>self</i>, bool&#160;<i>enabled</i>)</h3><h3 class="fn"><a name="setTiledBackingStoreFrozen" />QGraphicsWebView.setTiledBackingStoreFrozen (<i>self</i>, bool&#160;<i>frozen</i>)</h3><h3 class="fn"><a name="settings" /><a href="qwebsettings.html">QWebSettings</a> QGraphicsWebView.settings (<i>self</i>)</h3><p>Returns a pointer to the view/page specific settings object.</p>
<p>It is equivalent to</p>
<pre class="cpp">
