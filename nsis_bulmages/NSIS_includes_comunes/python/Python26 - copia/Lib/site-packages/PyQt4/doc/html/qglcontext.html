...
the plane's transparent color. Otherwise returns an <a href="qcolor.html#isValid">invalid</a> color.</p>
<p>The returned color's <a class="compat" href="qcolor-qt3.html#pixel">pixel</a> value is the index of the transparent color in
the colormap of the overlay plane. (Naturally, the color's RGB
values are meaningless.)</p>
...
graphics with a <a href="qpainter.html">QPainter</a>. See the
examples/opengl/overlay_x11 example for details.</p>
