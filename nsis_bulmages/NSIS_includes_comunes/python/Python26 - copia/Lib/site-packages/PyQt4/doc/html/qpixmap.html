...
streamed.</p>
<p>Depending on the system, QPixmap is stored using a RGB32 or a
...
Note also that QPixmap, unlike <a href="qimage.html">QImage</a>,
may be hardware dependent. On X11, Mac and Symbian, a QPixmap is
stored on the server side while a <a href="qimage.html">QImage</a>
is stored on the client side (on Windows, these two classes have an
equivalent internal representation, i.e. both <a href="qimage.html">QImage</a> and QPixmap are stored on the client side
and don't use any GDI resources).</p>
