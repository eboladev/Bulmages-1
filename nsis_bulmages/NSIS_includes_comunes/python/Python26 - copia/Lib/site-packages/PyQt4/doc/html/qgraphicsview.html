...
values, you can choose to use <a href="qgraphicsview.html#translate">translate</a>() to navigate the
scene instead.</p>
...
<p class="centerAlign"><img src="images/graphicsview-view.png" /></p>
