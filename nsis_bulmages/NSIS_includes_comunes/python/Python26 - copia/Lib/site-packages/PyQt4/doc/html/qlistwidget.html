...
position, it is more required to construct the item without a
parent widget and use the <a href="qlistwidget.html#insertItem">insertItem</a>() function to place it
within the list. The list widget will take ownership of the
item.</p>
<pre class="cpp">
