...
<pre class="cpp">
 ...
 <span class="type">QAudioOutput</span><span class="operator">*</span> audio; <span class="comment">// class member.</span>
</pre>
<pre class="cpp">
 ...
 audio <span class="operator">=</span> <span class="keyword">new</span> <span class="type">QAudioOutput</span>(format<span class="operator">,</span> <span class="keyword">this</span>);
 <a href="qobject.html#connect">connect</a>(audio<span class="operator">,</span>SIGNAL(stateChanged(<span class="type"><a href="qaudio.html">QAudio</a></span><span class="operator">.</span>State))<span class="operator">,</span>SLOT(finishedPlaying(<span class="type"><a href="qaudio.html">QAudio</a></span><span class="operator">.</span>State)));
 audio<span class="operator">-</span><span class="operator">&gt;</span><a href="qaudiooutput.html#start">start</a>(<span class="operator">&amp;</span>inputFile);
</pre>
...
<pre class="cpp">
     <span class="type">void</span> stateChanged(<span class="type"><a href="qaudio.html">QAudio</a></span><span class="operator">.</span>State newState)
     {
         <span class="keyword">switch</span> (newState) {
             <span class="keyword">case</span> <span class="type"><a href="qaudio.html">QAudio</a></span><span class="operator">.</span>StopState:
                 <span class="keyword">if</span> (output<span class="operator">-</span><span class="operator">&gt;</span>error() <span class="operator">!</span><span class="operator">=</span> <span class="type"><a href="qaudio.html">QAudio</a></span><span class="operator">.</span>NoError) {
