...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Introduction &mdash; PyQt 4.8.6 Reference Guide</title>
    ...
    <link rel="prev" title="PyQt Reference Guide" href="index.html" /> 
  </head>
  <body>
    <div class="related">
      <h3>Navigation</h3>
      <ul>
        ...
        <li class="right" >
          <a href="index.html" title="PyQt Reference Guide"
...
<p>This is the reference guide for PyQt 4.8.6.  PyQt v4 is a set of
...
<li>The <tt class="xref py py-mod docutils literal"><span class="pre">QAxContainer</span></tt> module.  This module contains classes that
allow access to ActiveX controls and COM objects.</li>
...
module is installed as <tt class="xref py py-mod docutils literal"><span class="pre">dbus.mainloop.qt</span></tt>.  PyQt does not support Qt&#8217;s
native DBus classes (which are very C++ orientated).  Instead the
<tt class="xref py py-mod docutils literal"><span class="pre">dbus.mainloop.qt</span></tt> module provides support for the Qt event loop in the
same way that the <tt class="xref py py-mod docutils literal"><span class="pre">dbus.mainloop.glib</span></tt> included with the standard
<tt class="docutils literal"><span class="pre">dbus-python</span></tt> bindings package provides support for the GLib event loop.
The API is described in <a class="reference internal" href="dbus.html#ref-dbus"><em>The DBus Support Module</em></a>.  It is only available for PyQt for
X11 and only if the <tt class="docutils literal"><span class="pre">dbus-python</span></tt> v0.80 (or later) bindings package is
installed.</li>
...
<li><a class="reference internal" href="#pyqt-components">PyQt Components</a></li>
</ul>
</li>
</ul>
  ...
  <p class="topless"><a href="index.html"
                        title="previous chapter">PyQt Reference Guide</a></p>
  <h4>Next topic</h4>
