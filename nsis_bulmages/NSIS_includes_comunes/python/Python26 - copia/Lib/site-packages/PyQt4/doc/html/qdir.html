...
<h3 class="fn"><a name="QDir-3" />QDir.__init__ (<i>self</i>, QString&#160;<i>path</i>, QString&#160;<i>nameFilter</i>, <a href="qdir-sortflags.html">SortFlags</a>&#160;<i>sort</i>&#160;=&#160;QDir.Name|QDir.IgnoreCase, <a href="qdir-filters.html">Filters</a>&#160;<i>filters</i>&#160;=&#160;QDir.TypeMask)</h3><p>Constructs a <a href="qdir.html">QDir</a> with path <i>path</i>,
...
returned by the <a href="qdir.html#rootPath">rootPath</a>(). On
Symbian always the same as the path returned by the <a href="qdir.html#rootPath">rootPath</a>().</p>
...
systems this normally returns "c:/". On Symbian this typically
returns "c:/data", i.e. the same as native
PathInfo.PhoneMemoryRootPath().</p>
...
directory.</p>
<p>On Unix/Linux systems this is usually <tt>/tmp</tt>; on Windows
this is usually the path in the <tt>TEMP</tt> or <tt>TMP</tt>
environment variable. Whether a directory separator is added to the
end or not, depends on the operating system.</p>
...
<h3 class="fn"><a name="__contains__" />int QDir.__contains__ (<i>self</i>, QString)</h3><h3 class="fn"><a name="__eq__" />bool QDir.__eq__ (<i>self</i>, <a href="qdir.html">QDir</a>&#160;<i>dir</i>)</h3><h3 class="fn"><a name="__getitem__" />QString QDir.__getitem__ (<i>self</i>, int)</h3><h3 class="fn"><a name="__getitem__-2" />QStringList QDir.__getitem__ (<i>self</i>, slice)</h3><h3 class="fn"><a name="__len__" /> QDir.__len__ (<i>self</i>)</h3><h3 class="fn"><a name="__ne__" />bool QDir.__ne__ (<i>self</i>, <a href="qdir.html">QDir</a>&#160;<i>dir</i>)</h3><address><hr /><div align="center"><table border="0" cellspacing="0" width="100%"><tr class="address"><td align="left" width="25%">PyQt&#160;4.8.6 for Windows</td><td align="center" width="50%">Copyright &#169; <a href="http://www.riverbankcomputing.com">Riverbank&#160;Computing&#160;Ltd</a> and <a href="http://www.qtsoftware.com">Nokia</a> 2011</td><td align="right" width="25%">Qt&#160;4.7.4</td></tr></table></div></address></body></html>