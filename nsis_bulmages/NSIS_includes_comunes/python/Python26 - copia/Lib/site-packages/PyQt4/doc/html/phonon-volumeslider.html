...
<h3 class="fn"><a name="audioOutput" /><a href="phonon-audiooutput.html">AudioOutput</a> VolumeSlider.audioOutput (<i>self</i>)</h3><p><b>See also</b> <a href="phonon-volumeslider.html#setAudioOutput">setAudioOutput</a>().</p>
