...
supplied by a <a class="obsolete" href="qdirmodel.html">QDirModel<sup>(obsolete)</sup></a> and displayed as a
tree:</p>
<pre class="cpp">
...
<h3 class="fn"><a name="doItemsLayout" />QTreeView.doItemsLayout (<i>self</i>)</h3><h3 class="fn"><a name="dragMoveEvent" />QTreeView.dragMoveEvent (<i>self</i>, <a href="qdragmoveevent.html">QDragMoveEvent</a>&#160;<i>event</i>)</h3><p>Reimplemented from <a href="qwidget.html#dragMoveEvent">QWidget.dragMoveEvent</a>().</p>
