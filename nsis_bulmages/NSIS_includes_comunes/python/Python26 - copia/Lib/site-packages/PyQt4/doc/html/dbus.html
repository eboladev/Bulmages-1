...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>The DBus Support Module &mdash; PyQt 4.8.6 Reference Guide</title>
    ...
    <link rel="prev" title="Internationalisation of PyQt Applications" href="i18n.html" /> 
  </head>
  <body>
    <div class="related">
      <h3>Navigation</h3>
...
<span id="ref-dbus"></span><h1>The DBus Support Module<a class="headerlink" href="#the-dbus-support-module" title="Permalink to this headline">¶</a></h1>
<p>The DBus support module is installed as <tt class="xref py py-mod docutils literal"><span class="pre">dbus.mainloop.qt</span></tt> and provides
...
<tt class="xref py py-mod docutils literal"><span class="pre">dbus.mainloop.glib</span></tt> modules that provides support for the GLib event loop.</p>
...
<tbody valign="top">
<tr class="field"><th class="field-name">Parameters:</th><td class="field-body"><strong>set_as_default</strong> &#8211; is optionally set to make the main loop instance the default for all
...
<span class="n">DBusQtMainLoop</span><span class="p">(</span><span class="n">set_as_default</span><span class="o">=</span><span class="bp">True</span><span class="p">)</span>
  ...
  <p class="topless"><a href="i18n.html"
                        title="previous chapter">Internationalisation of PyQt Applications</a></p>
  <h4>Next topic</h4>
