...
<h3 class="fn"><a name="actionRaise" /><a href="qaction.html">QAction</a> QDesignerFormWindowManagerInterface.actionRaise (<i>self</i>)</h3><p>The <i>QAction</i> result</p><p>Allows you to intervene and control the action of raising of a
form window in <i>Qt Designer</i>'s workspace. The function returns
the original action.</p>
<p><b>See also</b> <a href="qaction.html">QAction</a>.</p>
