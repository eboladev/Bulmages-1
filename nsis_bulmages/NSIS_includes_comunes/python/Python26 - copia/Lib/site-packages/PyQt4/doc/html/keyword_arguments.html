...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Support for Keyword Arguments &mdash; PyQt 4.8.6 Reference Guide</title>
    ...
    <link rel="prev" title="PyQt and Python v3" href="python_v3.html" /> 
  </head>
  <body>
    <div class="related">
      <h3>Navigation</h3>
...
<h1>Support for Keyword Arguments<a class="headerlink" href="#support-for-keyword-arguments" title="Permalink to this headline">¶</a></h1>
...
documentation will also contain the correct argument names.</p>
  ...
  <p class="topless"><a href="python_v3.html"
                        title="previous chapter">PyQt and Python v3</a></p>
  <h4>Next topic</h4>
