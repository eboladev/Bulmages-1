// qsettings.sip generated by MetaSIP on Mon Oct 24 12:33:59 2011
//
...
public:
    ...
    SIP_PYOBJECT value(const QString &key, const QVariant &defaultValue /DocValue="Py_v3:None"/ = QVariant(), SIP_PYOBJECT type /DocValue="None"/ = 0) const;
%MethodCode
        sipRes = qpycore_qsettings_value(sipCpp, *a0, *a1, a2);
