...
_pkg_config = {
    ...
    'pyqt_sip_flags':    '-x VendorID -t WS_WIN -x PyQt_Accessibility -x PyQt_NoPrintRangeBug -t Qt_4_7_2 -x Py_v3 -g',
    'pyqt_version':      0x040806,
    'pyqt_version_str':  '4.8.6',
    'qt_data_dir':       'C:\\Qt\\4.7.4',
    'qt_dir':            'C:\\Qt\\4.7.4',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'C:\\Qt\\4.7.4\\include',
    'qt_lib_dir':        'C:\\Qt\\4.7.4\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040704,
    'qt_winconfig':      'shared'
}
