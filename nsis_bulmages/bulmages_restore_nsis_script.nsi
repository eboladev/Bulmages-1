...
;General
  ...
  OutFile "Bulmages_Restore_Tool.exe"
...
;  !define MUI_UNICON "bulmages_fact_uninstall.ico"
...
;Pages
  ...
  !define MUI_WELCOMEPAGE_TITLE "Restauración de Backups de Bulmages"
  !define MUI_WELCOMEPAGE_TITLE_3LINES
  !define MUI_WELCOMEPAGE_TEXT "Esta utilidad permite restaurar Backups realizados"
...
Section "BulBackup" SecInstall
  ...
  DetailPrint 'Activando base de datos...'
	...
	nsExec::Exec 'xcopy "$FOLDERBACKUP\img_articles" "$ORIGENDIR\pgsql\data\img_articles" /S /I /Y'
	nsExec::Exec 'xcopy  "$FOLDERBACKUP\openreports" "$ORIGENDIR\openreports" /S /I /Y'
	nsExec::Exec '"$ORIGENDIR\pgsql\bin\psql.exe"  -f "$FOLDERBACKUP\dbbackup.sql" template1'
