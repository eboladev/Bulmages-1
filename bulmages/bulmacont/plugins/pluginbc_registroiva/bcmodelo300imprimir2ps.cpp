...
{
    blDebug ( "BcModelo300Imprimir2PS::BcModelo300Imprimir2PS", 0 );
    setupUi ( this );
...
//        cout << nombresccc[i].toAscii().constData() << "\t" << numerccc[i].toAscii().constData() << "\n";
    ...
    blDebug ( "END BcModelo300Imprimir2PS::BcModelo300Imprimir2PS", 0 );
}
...
{
    blDebug ( "BcModelo300Imprimir2PS::accept", 0 );
...
//    cout << "dc=" << ccc->getdc().toAscii().constData() << "\n";
    ...
    blDebug ( "END BcModelo300Imprimir2PS::accept", 0 );
}
...
{
    blDebug ( "BcModelo300Imprimir2PS::generaps", 0 );
...
//        cout << psname.toAscii().constData();
        ...
        if ( m_fich.open ( QIODevice::WriteOnly ) ) {
            ...
            if ( !m_fichlec.open ( QIODevice::ReadOnly | QIODevice::Text ) ) {
                blDebug ( "Error al abrir fichero de lectura!!", 2 );
                exit ( 1 );
            } // end if
...
//            cout << "[TODO]  Es decir, hay que bajarse de internet uno nuevo CADA VEZ que se haga un modelo nuevo\n";
            ...
            blDebug ( "EEEEHH!!! !QUE NO  HE ABIERTO EL FICHEROOOOOOOOOO!", 2 );
        } // end if
    } // end if
    blDebug ( "END BcModelo300Imprimir2PS::generaps", 0 );
}
...
{
    blDebug ( "BcModelo300Imprimir2PS::personalButtonPressed", 0 );
    ...
    blDebug ( "END BcModelo300Imprimir2PS::personalButtonPressed", 0 );
}
...
{
    blDebug ( "BcModelo300Imprimir2PS::escribe_postscriptdefs", 0 );
    ...
    "  show} def\n";
    blDebug ( "END BcModelo300Imprimir2PS::escribe_postscriptdefs", 0 );
}
...
{
    blDebug ( "BcModelo300Imprimir2PS::escribe_cuenta_bancaria", 0 );
    ...
    blDebug ( "END BcModelo300Imprimir2PS::escribe_cuenta_bancaria", 0 );
}
...
{
    blDebug ( "BcModelo300Imprimir2PS::rellena_identificacion", 0 );
    QString cad1;
    ...
    blDebug ( "END BcModelo300Imprimir2PS::rellena_identificacion", 0 );
}
...
{
    blDebug ( "BcModelo300Imprimir2PS::rellena_liquidacion", 0 );
    ...
    blDebug ( "END BcModelo300Imprimir2PS::rellena_liquidacion", 0 );
}
...
{
    blDebug ( "BcModelo300Imprimir2PS::rellena_compensacion", 0 );
    if ( cas34 < 0 ) {
    ...
    blDebug ( "END BcModelo300Imprimir2PS::rellena_compensacion", 0 );
}
...
{
    blDebug ( "BcModelo300Imprimir2PS::escribe_codigo_postal", 0 );
    int offset = 3;
    ...
    blDebug ( "END BcModelo300Imprimir2PS::escribe_codigo_postal", 0 );
}
