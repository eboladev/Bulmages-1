...
BEGIN
	...
	IF FOUND THEN
		UPDATE CONFIGURACION SET valor=''0.10.1-0001'' WHERE nombre=''DBRev-PresContables'';
	ELSE
		INSERT INTO configuracion (nombre, valor) VALUES (''DBRev-PresContables'', ''0.10.1-0001'');
	END IF;
	RETURN 0;
END;
'   LANGUAGE plpgsql;
