...
//    fitxersortidatxt += "doc.set_cell_value(" + QString::number ( x++ ) + "," + QString::number ( y ) + ", 'string', '" + textocontenido + "')\n\n";
    ...
    BlDbRecordSet *curej = mainCompany()->cargacursor ( queryej );
    while ( !curej->eof() ) {
        ...
        BlDbRecordSet *curcta = mainCompany()->cargacursor ( querycta );
        while ( !curcta->eof() ) {
            ...
            BlDbRecordSet * curing = mainCompany()->cargacursor ( queryinc );
            while ( !curing->eof() ) {
            ...
            BlDbRecordSet *curling = mainCompany()->cargacursor ( queryling );
            while ( !curling->eof() ) {
            ...
            BlDbRecordSet *curlgas = mainCompany()->cargacursor ( querylgas );
            while ( !curlgas->eof() ) {
