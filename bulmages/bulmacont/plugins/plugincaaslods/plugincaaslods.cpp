...
\return
**/
Fixed pluginCAaslODS::cuentaPositiva( Fixed valor )
{
    _depura ( "pluginCAaslODS::cuentaPositiva", 0 );
...
\return
**/
Fixed pluginCAaslODS::cuentaNevativa( Fixed valor )
{
    _depura ( "pluginCAaslODS::cuentaNegativa", 0 );
