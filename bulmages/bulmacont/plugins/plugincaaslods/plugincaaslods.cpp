...
/**
**/
pluginCAaslODS::pluginCAaslODS()
{
    _depura ( "pluginCAaslODS::pluginCAaslODS", 0 );
    _depura ( "END pluginCAaslODS::pluginCAaslODS", 0 );
}
...
\return
**/
Fixed pluginCAaslODS::saldoCuenta ( int cuenta )
{
    _depura ( "pluginCAaslODS::saldoCuenta", 0 );
    /// Ejercicio actual.
    QString query;
    cursor2 *cur;
    Fixed resultado;
    ...
    conexionbase->commit();
    _depura ( "END pluginCAaslODS::saldoCuenta", 0 );
    return resultado;
}
...
\return
**/
Fixed pluginCAaslODS::saldoCuentaAnt ( int cuenta )
{
    _depura ( "pluginCAaslODS::saldoCuentaAnt", 0 );
    /// Ejercicio anterior.
    QString query;
    cursor2 *cur;
    Fixed resultado;
    ...
    resultado = cur->valor ( "saldo" );
    conexionbase->commit();
    _depura ( "END pluginCAaslODS::saldoCuentaAnt", 0 );
    return resultado;
}
...
\return
**/
void pluginCAaslODS::formDatosBalance()
{
    _depura ( "pluginCAaslODS::formDatosBalance", 0 );
    int resultado;
    ...
    balanceSituacionODS();
    _depura ( "END pluginCAaslODS::formDatosBalance", 0 );
}
...
/**
**/
void pluginCAaslODS::balanceSituacionODS()
{
    _depura ( "pluginCAaslODS::balanceSituacionODS", 0 );
...
doc.set_cell_value(3, 19, 'float', '" + ( saldoCuenta ( 400 ) + saldoCuenta ( 401 ) + saldoCuenta ( 402 ) + saldoCuenta ( 403 ) + ( -saldoCuenta ( 406 ) ) + saldoCuenta ( 41 ) + saldoCuenta ( 437 ) + saldoCuenta ( 465 ) + saldoCuenta ( 475 ) + saldoCuenta ( 476 ) + saldoCuenta ( 477 ) + saldoCuenta ( 479 ) + saldoCuenta ( 485 ) + saldoCuenta ( 499 ) + saldoCuenta ( 50 ) + saldoCuenta ( 51 ) + saldoCuenta ( 52 ) + saldoCuenta ( 551 ) + saldoCuenta ( 552 ) + saldoCuenta ( 553 ) + saldoCuenta ( 555 ) + saldoCuenta ( 556 ) + saldoCuenta ( 560 ) + saldoCuenta ( 561 ) + saldoCuenta ( 585 ) ).toQString ( '.' ) + "')\n\
doc.set_cell_value(4, 19, 'float', '" + ( saldoCuentaAnt ( 400 ) + saldoCuentaAnt ( 401 ) + saldoCuentaAnt ( 402 ) + saldoCuentaAnt ( 403 ) + ( -saldoCuentaAnt ( 406 ) ) + saldoCuentaAnt ( 41 ) + saldoCuentaAnt ( 437 ) + saldoCuentaAnt ( 465 ) + saldoCuentaAnt ( 475 ) + saldoCuentaAnt ( 476 ) + saldoCuentaAnt ( 477 ) + saldoCuentaAnt ( 479 ) + saldoCuentaAnt ( 485 ) + saldoCuentaAnt ( 499 ) + saldoCuentaAnt ( 50 ) + saldoCuentaAnt ( 51 ) + saldoCuentaAnt ( 52 ) + saldoCuentaAnt ( 551 ) + saldoCuentaAnt ( 552 ) + saldoCuentaAnt ( 553 ) + saldoCuentaAnt ( 555 ) + saldoCuentaAnt ( 556 ) + saldoCuentaAnt ( 560 ) + saldoCuentaAnt ( 561 ) + saldoCuentaAnt ( 585 ) ).toQString ( '.' ) + "')\n\
doc.set_cell_property('bold', False)\n\
\
doc.set_cell_property('bold', True)\n\
...
doc.set_cell_value(3, 20, 'formula', '=Haber.C8+Haber.C13+Haber.C14-C8-C12-C13-C16-C17-C18')\n\
doc.set_cell_value(4, 20, 'formula', '=Haber.D8+Haber.D13+Haber.D14-D8-D12-D13-D16-D17-D18')\n\
\
...
doc.set_cell_value(3, 33, 'formula', '=C20+C30-Haber.C16-Haber.C26')\n\
doc.set_cell_value(4, 33, 'formula', '=D20+D30-Haber.D16-Haber.D26')\n\
\
...
doc.set_cell_value(3, 42, 'formula', '=Haber.C32+Haber.C33+Haber.C34+Haber.C35+Haber.C36-C37-C38-C39-C40')\n\
doc.set_cell_value(4, 42, 'formula', '=Haber.D32+Haber.D33+Haber.D34+Haber.D35+Haber.D36-D37-D38-D39-D40')\n\
\
doc.set_cell_value(2, 45, 'string', '   V.   RESULTADOS POSITIVOS ANTES DE IMPUESTOS')\n\
doc.set_cell_value(2, 46, 'string', '        (AIII+AIV-BIII-BIV)')\n\
doc.set_cell_value(3, 45, 'formula', '=C33+C42-Haber.C29-Haber.C38')\n\
doc.set_cell_value(4, 45, 'formula', '=D33+D42-Haber.D29-Haber.D38')\n\
\
...
doc.set_cell_value(3, 51, 'formula', '=C45-C48-C49')\n\
doc.set_cell_value(4, 51, 'formula', '=D45-D48-D49')\n\
\
\
\
\
...
doc.set_cell_value(3, 16, 'formula', '=Debe.C8+Debe.C12+Debe.C13+Debe.C16+Debe.C17+Debe.C18-C8-C13-C14')\n\
doc.set_cell_value(4, 16, 'formula', '=Debe.D8+Debe.D12+Debe.D13+Debe.D16+Debe.D17+Debe.D18-D8-D13-D14')\n\
\
...
doc.set_cell_value(3, 26, 'formula', '=Debe.C23+Debe.C28+Debe.C29-C19-C24')\n\
doc.set_cell_value(4, 26, 'formula', '=Debe.D23+Debe.D28+Debe.D29-D19-D24')\n\
\
...
doc.set_cell_value(3, 29, 'formula', '=C16+C26-Debe.C20-Debe.C30')\n\
doc.set_cell_value(4, 29, 'formula', '=D16+D26-Debe.D20-Debe.D30')\n\
\
...
doc.set_cell_value(3, 38, 'formula', '=Debe.C36+Debe.C37+Debe.C38+Debe.C39+Debe.C40-C32-C33-C34-C35-C36')\n\
doc.set_cell_value(4, 38, 'formula', '=Debe.D36+Debe.D37+Debe.D38+Debe.D39+Debe.D40-D32-D33-D34-D35-D36')\n\
\
doc.set_cell_value(2, 41, 'string', '   V.  RESULTADOS NEGATIVOS ANTES DE IMPUESTOS')\n\
doc.set_cell_value(2, 42, 'string', '       (BIII+BIV-AIII-AIV)')\n\
doc.set_cell_value(3, 41, 'formula', '=C29+C38-Debe.C33-Debe.C42')\n\
doc.set_cell_value(4, 41, 'formula', '=D29+D38-Debe.D33-Debe.D42')\n\
\
doc.set_cell_value(2, 44, 'string', '   VI. EXCEDENTE NEGATIVO DEL EJERCICIO (DESAHORRO)')\n\
doc.set_cell_value(2, 45, 'string', '       (BV+A15+A16)')\n\
doc.set_cell_value(3, 44, 'formula', '=C41+Debe.C48+Debe.C49')\n\
doc.set_cell_value(4, 44, 'formula', '=D41+Debe.D48+Debe.D49')\n\
\
\
\
\
...
doc.save(\"canualesods.ods\")\n";
    ...
    system ( cadena.toAscii() );
    _depura ( "END pluginCAaslODS::balanceSituacionODS", 0 );
}
...
///
    ...
    \param bcont
    **/
    void pluginCAaslODS::inicializa ( Bulmacont *bcont )
{
    _depura ( "pluginCAaslODS::inicializa", 0 );
    ...
    _depura ( "END pluginCAaslODS::inicializa", 0 );
}
    ...
    void entryPoint ( Bulmacont *bcont )
{
    ...
    pluginCAaslODS *plug = new pluginCAaslODS();
