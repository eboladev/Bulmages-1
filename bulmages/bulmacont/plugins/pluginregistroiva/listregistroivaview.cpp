        ...
        : QWidget ( parent )
{
    ...
    mui_tablasoportado->addSHeader ( "idregistroiva", DBCampo::DBvarchar, DBCampo::DBNotNull, BlSubFormHeader::DBNoWrite, _( "Id" ) );
    mui_tablasoportado->addSHeader ( "contrapartida", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite, _( "Concepto contable" ) );
    mui_tablasoportado->addSHeader ( "baseimp", DBCampo::DBvarchar, DBCampo::DBNotNull, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "idcuenta" ) );
    mui_tablasoportado->addSHeader ( "iva", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "IVA" ) );
    mui_tablasoportado->addSHeader ( "ffactura", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "Fecha de factura" ) );
    mui_tablasoportado->addSHeader ( "femisionregistroiva", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "descripcioncuenta" ) );
    mui_tablasoportado->addSHeader ( "factura", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite, _( "descripcion" ) );
    mui_tablasoportado->addSHeader ( "serieregistroiva", DBCampo::DBnumeric, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite, _( "Debe" ) );
    mui_tablasoportado->addSHeader ( "idborrador", DBCampo::DBnumeric, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite, _( "Haber" ) );
    mui_tablasoportado->addSHeader ( "incregistro", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "Contrapartida" ) );
    mui_tablasoportado->addSHeader ( "regularizacion", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "Comentario" ) );
    mui_tablasoportado->addSHeader ( "plan349", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "ID Canal" ) );
    mui_tablasoportado->addSHeader ( "numorden", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "Conciliacion" ) );
    mui_tablasoportado->addSHeader ( "cif", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "idc_coste" ) );
    mui_tablasoportado->addSHeader ( "idfpago", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "idapunte" ) );
    mui_tablasoportado->addSHeader ( "factemitida", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "idtipoiva" ) );
    mui_tablasoportado->addSHeader ( "rectificaaregistroiva", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "orden" ) );
    mui_tablasoportado->addSHeader ( "idasiento", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "idasiento" ) );
    ...
    mui_tablarepercutido->addSHeader ( "idregistroiva", DBCampo::DBvarchar, DBCampo::DBNotNull, BlSubFormHeader::DBNoWrite, _( "Id" ) );
    mui_tablarepercutido->addSHeader ( "contrapartida", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite, _( "Concepto Contable" ) );
    mui_tablarepercutido->addSHeader ( "baseimp", DBCampo::DBvarchar, DBCampo::DBNotNull, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "idcuenta" ) );
    mui_tablarepercutido->addSHeader ( "iva", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "codigo" ) );
    mui_tablarepercutido->addSHeader ( "ffactura", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "tipocuenta" ) );
    mui_tablarepercutido->addSHeader ( "femisionregistroiva", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "descripcioncuenta" ) );
    mui_tablarepercutido->addSHeader ( "factura", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "descripcion" ) );
    mui_tablarepercutido->addSHeader ( "serieregistroiva", DBCampo::DBnumeric, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "Debe" ) );
    mui_tablarepercutido->addSHeader ( "idborrador", DBCampo::DBnumeric, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "Haber" ) );
    mui_tablarepercutido->addSHeader ( "incregistro", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "Contrapartida" ) );
    mui_tablarepercutido->addSHeader ( "regularizacion", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "Comentario" ) );
    mui_tablarepercutido->addSHeader ( "plan349", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "ID Canal" ) );
    mui_tablarepercutido->addSHeader ( "numorden", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "Conciliacion" ) );
    mui_tablarepercutido->addSHeader ( "cif", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "idc_coste" ) );
    mui_tablarepercutido->addSHeader ( "idfpago", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "idapunte" ) );
    mui_tablarepercutido->addSHeader ( "factemitida", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "idtipoiva" ) );
    mui_tablarepercutido->addSHeader ( "rectificaaregistroiva", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "orden" ) );
    mui_tablarepercutido->addSHeader ( "idasiento", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "idasiento" ) );
    ...
    mui_totalRepercutido->addSHeader ( "nombretipoiva", DBCampo::DBvarchar, DBCampo::DBNotNull, BlSubFormHeader::DBNoWrite, _( "nombretipoiva" ) );
    mui_totalRepercutido->addSHeader ( "tivaiva", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite, _( "tivaiva" ) );
    mui_totalRepercutido->addSHeader ( "tbaseiva", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite, _( "tbaseiva" ) );
    ...
    mui_totalSoportado->addSHeader ( "nombretipoiva", DBCampo::DBvarchar, DBCampo::DBNotNull, BlSubFormHeader::DBNoWrite, _( "nombretipoiva" ) );
    mui_totalSoportado->addSHeader ( "tivaiva", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite, _( "tivaiva" ) );
    mui_totalSoportado->addSHeader ( "tbaseiva", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite, _( "tbaseiva" ) );
