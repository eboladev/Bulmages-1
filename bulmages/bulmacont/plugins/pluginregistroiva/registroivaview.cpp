        ...
        :  RegistroIva ( comp, parent )
{
    ...
    mui_listIva->addSHeader ( "idiva", BlDbField::DBint, BlDbField::DBPrimaryKey, BlSubFormHeader::DBNoWrite, _( "idiva" ) );
    mui_listIva->addSHeader ( "idtipoiva", BlDbField::DBint, BlDbField::DBNotNull, BlSubFormHeader::DBNoWrite, _( "idtipoiva" ) );
    mui_listIva->addSHeader ( "idcuenta", BlDbField::DBint, BlDbField::DBNoSave, BlSubFormHeader::DBNoWrite, _( "idcuenta" ) );
    mui_listIva->addSHeader ( "codigo", BlDbField::DBvarchar, BlDbField::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "codigo" ) );
    mui_listIva->addSHeader ( "tipocuenta", BlDbField::DBvarchar, BlDbField::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "tipocuenta" ) );
    mui_listIva->addSHeader ( "nombretipoiva", BlDbField::DBvarchar, BlDbField::DBNoSave, BlSubFormHeader::DBNoWrite, _( "nombretipoiva" ) );
    mui_listIva->addSHeader ( "idregistroiva", BlDbField::DBint, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "idregistroiva" ) );
    mui_listIva->addSHeader ( "baseiva", BlDbField::DBnumeric, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "baseiva" ) );
    mui_listIva->addSHeader ( "ivaiva", BlDbField::DBnumeric, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "ivaiva" ) );
    mui_listIva->setinsercion ( FALSE );

    mui_listPrevCobro->setDBTableName ( "prevcobro" );
    mui_listPrevCobro->setDBCampoId ( "idprevcobro" );
    mui_listPrevCobro->addSHeader ( "idprevcobro", BlDbField::DBint, BlDbField::DBPrimaryKey, BlSubFormHeader::DBNoWrite, _( "idprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "fprevistaprevcobro", BlDbField::DBdate, BlDbField::DBNotNull, BlSubFormHeader::DBNone, _( "fprevistaprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "fcobroprevcobro", BlDbField::DBdate, BlDbField::DBNoSave, BlSubFormHeader::DBNone, _( "fcobroprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "idfpago", BlDbField::DBint, BlDbField::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "idfpago" ) );
    mui_listPrevCobro->addSHeader ( "idcuenta", BlDbField::DBint, BlDbField::DBNoSave, BlSubFormHeader::DBNoWrite, _( "idcuenta" ) );
    mui_listPrevCobro->addSHeader ( "idasiento", BlDbField::DBint, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "idasiento" ) );
    mui_listPrevCobro->addSHeader ( "cantidadprevistaprevcobro", BlDbField::DBnumeric, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "cantidadprevistaprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "cantidadprevcobro", BlDbField::DBnumeric, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "cantidadprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "idregistroiva", BlDbField::DBint, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "idregistroiva" ) );
    mui_listPrevCobro->addSHeader ( "tipoprevcobro", BlDbField::DBint, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "tipoprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "docprevcobro", BlDbField::DBvarchar, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "docprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "codigo", BlDbField::DBvarchar, BlDbField::DBNoSave, BlSubFormHeader::DBNone, _( "codigo" ) );
    mui_listIva->addSHeader ( "tipocuenta", BlDbField::DBvarchar, BlDbField::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "tipocuenta" ) );
    mui_listPrevCobro->addSHeader ( "descripcion", BlDbField::DBnumeric, BlDbField::DBNoSave, BlSubFormHeader::DBNone, _( "descripcion" ) );
    mui_listPrevCobro->addSHeader ( "idctacliente", BlDbField::DBnumeric, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "idctacliente" ) );
    mui_listPrevCobro->addSHeader ( "codigoctacliente", BlDbField::DBnumeric, BlDbField::DBNoSave, BlSubFormHeader::DBNone, _( "codigoctacliente" ) );
    mui_listPrevCobro->addSHeader ( "nomctacliente", BlDbField::DBnumeric, BlDbField::DBNoSave, BlSubFormHeader::DBNone, _( "nomctacliente" ) );
    mui_listPrevCobro->addSHeader ( "tipoctacliente", BlDbField::DBnumeric, BlDbField::DBNoSave, BlSubFormHeader::DBNone, _( "tipoctacliente" ) );
    mui_listPrevCobro->addSHeader ( "tipocuenta", BlDbField::DBnumeric, BlDbField::DBNoSave, BlSubFormHeader::DBNone, _( "tipocuenta" ) );
