        ...
        :  RegistroIva ( comp, parent )
{
    ...
    mui_listIva->addSHeader ( "idiva", DBCampo::DBint, DBCampo::DBPrimaryKey, BlSubFormHeader::DBNoWrite, _( "idiva" ) );
    mui_listIva->addSHeader ( "idtipoiva", DBCampo::DBint, DBCampo::DBNotNull, BlSubFormHeader::DBNoWrite, _( "idtipoiva" ) );
    mui_listIva->addSHeader ( "idcuenta", DBCampo::DBint, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "idcuenta" ) );
    mui_listIva->addSHeader ( "codigo", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "codigo" ) );
    mui_listIva->addSHeader ( "tipocuenta", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "tipocuenta" ) );
    mui_listIva->addSHeader ( "nombretipoiva", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "nombretipoiva" ) );
    mui_listIva->addSHeader ( "idregistroiva", DBCampo::DBint, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "idregistroiva" ) );
    mui_listIva->addSHeader ( "baseiva", DBCampo::DBnumeric, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "baseiva" ) );
    mui_listIva->addSHeader ( "ivaiva", DBCampo::DBnumeric, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "ivaiva" ) );
    mui_listIva->setinsercion ( FALSE );

    mui_listPrevCobro->setDBTableName ( "prevcobro" );
    mui_listPrevCobro->setDBCampoId ( "idprevcobro" );
    mui_listPrevCobro->addSHeader ( "idprevcobro", DBCampo::DBint, DBCampo::DBPrimaryKey, BlSubFormHeader::DBNoWrite, _( "idprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "fprevistaprevcobro", DBCampo::DBdate, DBCampo::DBNotNull, BlSubFormHeader::DBNone, _( "fprevistaprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "fcobroprevcobro", DBCampo::DBdate, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "fcobroprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "idfpago", DBCampo::DBint, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "idfpago" ) );
    mui_listPrevCobro->addSHeader ( "idcuenta", DBCampo::DBint, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "idcuenta" ) );
    mui_listPrevCobro->addSHeader ( "idasiento", DBCampo::DBint, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "idasiento" ) );
    mui_listPrevCobro->addSHeader ( "cantidadprevistaprevcobro", DBCampo::DBnumeric, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "cantidadprevistaprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "cantidadprevcobro", DBCampo::DBnumeric, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "cantidadprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "idregistroiva", DBCampo::DBint, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "idregistroiva" ) );
    mui_listPrevCobro->addSHeader ( "tipoprevcobro", DBCampo::DBint, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "tipoprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "docprevcobro", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "docprevcobro" ) );
    mui_listPrevCobro->addSHeader ( "codigo", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "codigo" ) );
    mui_listIva->addSHeader ( "tipocuenta", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "tipocuenta" ) );
    mui_listPrevCobro->addSHeader ( "descripcion", DBCampo::DBnumeric, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "descripcion" ) );
    mui_listPrevCobro->addSHeader ( "idctacliente", DBCampo::DBnumeric, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "idctacliente" ) );
    mui_listPrevCobro->addSHeader ( "codigoctacliente", DBCampo::DBnumeric, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "codigoctacliente" ) );
    mui_listPrevCobro->addSHeader ( "nomctacliente", DBCampo::DBnumeric, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "nomctacliente" ) );
    mui_listPrevCobro->addSHeader ( "tipoctacliente", DBCampo::DBnumeric, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "tipoctacliente" ) );
    mui_listPrevCobro->addSHeader ( "tipocuenta", DBCampo::DBnumeric, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "tipocuenta" ) );
