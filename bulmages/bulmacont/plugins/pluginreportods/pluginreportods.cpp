...
void pluginReportODS::balanceSituacionODS(CAnuales tipus)
{
	...
	switch (tipus)
	{
		...
		default:
			mensajeError ( "ERROR: Función no implementada todavía.");
            break;
	}
    ...
    void pluginReportODS::inicializa ( Bulmacont *bcont )
{
	...
	QAction *accion1 = new QAction ( tr("&Balance de situación CAAASL"), 0 );
	...
	QAction *accion2 = new QAction ( tr("&Balance de situación CAPGC07"), 0 );
	...
	QAction *accion3 = new QAction ( tr("&Balance de situación CAPYMES08"), 0 );
	...
	QAction *accion4 = new QAction ( tr("&Balance de situación CAPGC08"), 0 );
	...
	QAction *accion5 = new QAction ( tr("&Balance de situación CAAPGC08"), 0 );
