...
QString PluginBc_CuentasAnuales2ODS::cuentaAnualCAPYMES08()
{
    ...
    if ( saldo551 > 0 ) {
        ...
        activo551actual = 0;
        pasivo551actual = saldo551;
    }
    saldo551 = saldoCuentaAnt ( 551 );
    if ( saldo551 > 0 ) {
        activo551anterior = saldo551;
        pasivo551anterior = 0;
    } else {
        activo551anterior = 0;
        pasivo551anterior = saldo551;
    }
...
doc.set_cell_value(5,4, 'string', '" + ejercicioAnterior + "')\n\
...
doc.set_cell_value(4,23, 'float', '" + ( saldoCuenta ( 5305 ) + saldoCuenta ( 5315 ) + saldoCuenta ( 5325 ) + saldoCuenta ( 5335 ) + saldoCuenta ( 5345 ) + saldoCuenta ( 5355 ) + saldoCuenta ( 5395 ) + saldoCuenta ( 540 ) + saldoCuenta ( 541 ) + saldoCuenta ( 542 ) + saldoCuenta ( 543 ) + saldoCuenta ( 545 ) + saldoCuenta ( 546 ) + saldoCuenta ( 547 ) + saldoCuenta ( 548 ) + saldoCuenta ( 549 ) + activo551actual + saldoCuenta ( 5525 ) + saldoCuenta ( 5590 ) + saldoCuenta ( 565 ) + saldoCuenta ( 566 ) + saldoCuenta ( 5935 ) + saldoCuenta ( 5945 ) + saldoCuenta ( 5955 ) + saldoCuenta ( 596 ) + saldoCuenta ( 597 ) + saldoCuenta ( 598 ) ).toQString ( '.' ) + "')\n\
doc.set_cell_value(5,23, 'float', '" + ( saldoCuentaAnt ( 5305 ) + saldoCuentaAnt ( 5315 ) + saldoCuentaAnt ( 5325 ) + saldoCuentaAnt ( 5335 ) + saldoCuentaAnt ( 5345 ) + saldoCuentaAnt ( 5355 ) + saldoCuentaAnt ( 5395 ) + saldoCuentaAnt ( 540 ) + saldoCuentaAnt ( 541 ) + saldoCuentaAnt ( 542 ) + saldoCuentaAnt ( 543 ) + saldoCuentaAnt ( 545 ) + saldoCuentaAnt ( 546 ) + saldoCuentaAnt ( 547 ) + saldoCuentaAnt ( 548 ) + saldoCuentaAnt ( 549 ) + activo551anterior + saldoCuentaAnt ( 5525 ) + saldoCuentaAnt ( 5590 ) + saldoCuentaAnt ( 565 ) + saldoCuentaAnt ( 566 ) + saldoCuentaAnt ( 5935 ) + saldoCuentaAnt ( 5945 ) + saldoCuentaAnt ( 5955 ) + saldoCuentaAnt ( 596 ) + saldoCuentaAnt ( 597 ) + saldoCuentaAnt ( 598 ) ).toQString ( '.' ) + "')\n\
doc.set_cell_property('bold', False)\n\
\
doc.set_cell_property('bold', True)\n\
