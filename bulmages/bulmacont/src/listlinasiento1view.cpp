        ...
        : SubForm2Bc ( parent )
{
    ...
    addSHeader ( "idapunte", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Id apunte" ) );
    addSHeader ( "fecha", DBCampo::DBvarchar, DBCampo::DBNotNull, BlSubFormHeader::DBNone, _( "Fecha" ) );
    addSHeader ( "codigo", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "Codigo" ) );
    addSHeader ( "descripcioncuenta", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite, _( "Nombre de la cuenta" ) );
    addSHeader ( "descripcion", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "Descripcion del apunte" ) );
    addSHeader ( "conceptocontable", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "Concepto contable" ) );
    addSHeader ( "debe", DBCampo::DBnumeric, DBCampo::DBNotNull, BlSubFormHeader::DBNone, _( "Debe" ) );
    addSHeader ( "haber", DBCampo::DBnumeric, DBCampo::DBNotNull, BlSubFormHeader::DBNone, _( "Haber" ) );
    addSHeader ( "contrapartida", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Contrapartida" ) );
    addSHeader ( "comentario", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Comentario" ) );
    addSHeader ( "idcanal", DBCampo::DBint, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "ID Canal" ) );
    addSHeader ( "nomcanal", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "Canal" ) );
    addSHeader ( "marcaconciliacion", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Conciliacion" ) );
    addSHeader ( "idc_coste", DBCampo::DBint, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Id centro de coste" ) );
    addSHeader ( "nomc_coste", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "Centro de coste" ) );
    addSHeader ( "idtipoiva", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Id tipo de IVA" ) );
    addSHeader ( "orden", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Orden" ) );
    addSHeader ( "idborrador", DBCampo::DBint,  DBCampo::DBPrimaryKey, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Id borrador" ) );
    addSHeader ( "idasiento", DBCampo::DBvarchar, DBCampo::DBNotNull, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Id asiento" ) );
    addSHeader ( "idcuenta", DBCampo::DBint, DBCampo::DBNotNull, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Id cuenta" ) );
    addSHeader ( "tipocuenta", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Tipo de cuenta" ) );
    addSHeader ( "idregistroiva", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Id. Registro IVA" ) );
    addSHeader ( "factura", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Fecha Factura" ) );
    addSHeader ( "ffactura", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoWrite | BlSubFormHeader::DBNoView, _( "Num. Factura" ) );
    setinsercion ( TRUE );
