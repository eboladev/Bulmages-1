...
int main ( int argc, char **argv )
{
   ...
   try {
      ...
      setlocale(LC_ALL, "");
      blBindTextDomain ("bulmacont", g_confpr->value(CONF_DIR_TRADUCCION).toLatin1().constData());
      ...
      g_plugins->loadLibs ( g_confpr->value( CONF_PLUGINS_BULMACONT ) );
      ...
      blMsgInfo ( _( "Error inesperado en BulmaCont, el programa se cerrara." ) );
   } // end try
