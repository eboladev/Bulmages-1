...
/********************************************************************************
 * Se ha pulsado sobre el bot� de agregar donde est�la suma                   *
 * Tenemos que a�dir la masa patrimonial o la cuenta a la suma                 *
 ********************************************************************************/
void mpatrimonialview::nuevasuma() {
   Q3ListViewItem *it;
   // Lo primero de todo es coger el c�igo de cuenta.
...
void mpatrimonialview::accept() {
   ...
   // Si idmpatrimonial == NULL implica que es una inserci� y no una modificacion
   if (idmpatrimonial == "") {
      conexionbase->begin();
