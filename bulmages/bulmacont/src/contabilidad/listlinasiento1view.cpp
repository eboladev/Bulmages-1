...
ListLinAsiento1View::ListLinAsiento1View(QWidget * parent, const char * name) : Q3Table(parent, name), ListLinAsiento1() {
    ...
    horizontalHeader()->setLabel( COL_SUBCUENTA, tr( "COL_SUBCUENTA" ) );
    ...
    horizontalHeader()->setLabel( COL_CCOSTE, tr( "COL_CCOSTE" ) );
    horizontalHeader()->setLabel( COL_CANAL, tr( "COL_CANAL" ) );
...
void ListLinAsiento1View::pintalinListLinAsiento1(int pos) {
    ...
    linea = m_lista.at(pos);
        ...
        setText(pos, COL_CCOSTE, linea->idc_coste());
        setText(pos, COL_CANAL, linea->idcanal());
