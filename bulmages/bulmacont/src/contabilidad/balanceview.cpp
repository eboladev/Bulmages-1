...
void balanceview::presentarSyS(QString finicial, QString ffinal, QString cinicial, QString cfinal, int nivel, int idc_coste, bool jerarquico) {
    ...
    headers << "CÛdigo" << "DenominaciÛn" << "Saldo anterior" << "Debe" << "Haber" << "Saldo" << "Debe ejercicio" << "Haber ejercicio" << "Saldo ejercicio";
...
//	    saldoej += lsaldoej.toDouble();
	    ...
	    // Las variables de las filas en formato espaÒol
    ...
    // Hacemos la actualizacion de los saldos totales en formato espaÒol y los ponemos en su Widget
