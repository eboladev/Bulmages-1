...
#ifndef BCBUSCARCUENTA_H
#define BCBUSCARCUENTA_H
...
#include "blwidget.h"
#include "ui_bcbuscarcuentabase.h"
...
class BC_EXPORT BcBuscarCuentaDelegate : public BlComboBox
{
    Q_OBJECT
...
public:
    BcBuscarCuentaDelegate ( QWidget *parent = 0 );
    ~BcBuscarCuentaDelegate();
...
class BC_EXPORT BcBuscarCuenta : public BlWidget, public Ui_BcBuscarCuentaBase
{
    Q_OBJECT
...
public:
    BcBuscarCuenta ( QWidget *parent = 0 );
    ~BcBuscarCuenta();
    QString text();
