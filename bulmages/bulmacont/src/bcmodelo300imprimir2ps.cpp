...
{
    _depura ( "BcModelo300Imprimir2PS::BcModelo300Imprimir2PS", 0 );
    setupUi ( this );
...
//        cout << nombresccc[i].toAscii().constData() << "\t" << numerccc[i].toAscii().constData() << "\n";
    ...
    _depura ( "END BcModelo300Imprimir2PS::BcModelo300Imprimir2PS", 0 );
}
...
{
    _depura ( "BcModelo300Imprimir2PS::accept", 0 );
...
//    cout << "dc=" << ccc->getdc().toAscii().constData() << "\n";
    ...
    _depura ( "END BcModelo300Imprimir2PS::accept", 0 );
}
...
//            cout << "[TODO]  Es decir, hay que bajarse de internet uno nuevo CADA VEZ que se haga un modelo nuevo\n";
    ...
    _depura ( "END BcModelo300Imprimir2PS::generaps", 0 );
}
...
{
    _depura ( "BcModelo300Imprimir2PS::personalButtonPressed", 0 );
    ...
    _depura ( "END BcModelo300Imprimir2PS::personalButtonPressed", 0 );
}
...
{
    _depura ( "BcModelo300Imprimir2PS::escribe_postscriptdefs", 0 );
    ...
    "  show} def\n";
    _depura ( "END BcModelo300Imprimir2PS::escribe_postscriptdefs", 0 );
}
...
{
    _depura ( "BcModelo300Imprimir2PS::escribe_cuenta_bancaria", 0 );
    ...
    _depura ( "END BcModelo300Imprimir2PS::escribe_cuenta_bancaria", 0 );
}
...
{
    _depura ( "BcModelo300Imprimir2PS::rellena_identificacion", 0 );
    QString cad1;
    ...
    _depura ( "END BcModelo300Imprimir2PS::rellena_identificacion", 0 );
}
...
{
    _depura ( "BcModelo300Imprimir2PS::rellena_liquidacion", 0 );
    ...
    _depura ( "END BcModelo300Imprimir2PS::rellena_liquidacion", 0 );
}
...
{
    _depura ( "BcModelo300Imprimir2PS::rellena_compensacion", 0 );
    if ( cas34 < 0 ) {
    ...
    _depura ( "END BcModelo300Imprimir2PS::rellena_compensacion", 0 );
}
...
{
    _depura ( "BcModelo300Imprimir2PS::escribe_codigo_postal", 0 );
    int offset = 3;
    ...
    _depura ( "END BcModelo300Imprimir2PS::escribe_codigo_postal", 0 );
}
