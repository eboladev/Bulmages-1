...
void BAlbaVenta::ScrollCabeceraV(int valor)
{
...
void BAlbaVenta::ScrollCabeceraH(int valor)
{
...
etiquetaGrande->setGeometry(420,contenedorBotonesLineas->pos().y()-2,contenedorLineas->width()-440,36);
//Zona Totales
