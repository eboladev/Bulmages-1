...
<pre class="cpp">
 ...
 <span class="type">QAudioInput</span><span class="operator">*</span> audio; <span class="comment">// class member.</span>
</pre>
<pre class="cpp">
 {
   ...
   audio <span class="operator">=</span> <span class="keyword">new</span> <span class="type">QAudioInput</span>(format<span class="operator">,</span> <span class="keyword">this</span>);
   ...
   audio<span class="operator">-</span><span class="operator">&gt;</span>start(<span class="operator">&amp;</span>outputFile);
...
<pre class="cpp">
 <span class="type">void</span> stopRecording()
 {
   ...
   outputFile<span class="operator">-</span><span class="operator">&gt;</span>close();
...
<pre class="cpp">
     <span class="type">void</span> stateChanged(<span class="type"><a href="qaudio.html">QAudio</a></span><span class="operator">.</span>State newState)
     {
         <span class="keyword">switch</span>(newState) {
             ...
             <span class="keyword">if</span> (input<span class="operator">-</span><span class="operator">&gt;</span>error() <span class="operator">!</span><span class="operator">=</span> <span class="type"><a href="qaudio.html">QAudio</a></span><span class="operator">.</span>NoError) {
