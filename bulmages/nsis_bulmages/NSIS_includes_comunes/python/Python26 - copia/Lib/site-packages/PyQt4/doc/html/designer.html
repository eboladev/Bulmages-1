...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Using Qt Designer &mdash; PyQt 4.8.6 Reference Guide</title>
    ...
    <link rel="next" title="The PyQt Resource System" href="resources.html" />
      ...
      <ul>
        ...
        <li class="right" >
          <a href="py-modindex.html" title="Python Module Index"
             >modules</a> |</li>
        <li class="right" >
          <a href="resources.html" title="The PyQt Resource System"
...
<p>PyQt does not wrap the <tt class="docutils literal"><span class="pre">QUiLoader</span></tt> class but instead includes the
...
interface.  PyQt&#8217;s <strong class="program">pyuic4</strong> utility is a command line interface to the
<a class="reference internal" href="#module-PyQt4.uic" title="PyQt4.uic"><tt class="xref py py-mod docutils literal"><span class="pre">uic</span></tt></a> module.  Both are described in detail in the following
sections.</p>
...
<tt class="descclassname">PyQt4.uic.</tt><tt class="descname">loadUiType</tt><big>(</big><em>uifile</em><span class="optional">[</span>, <em>from_imports=False</em><span class="optional">]</span><big>)</big><a class="headerlink" href="#PyQt4.uic.loadUiType" title="Permalink to this definition">¶</a></dt>
...
<tr class="field"><th class="field-name">Return type:</th><td class="field-body"><p class="first last">the <em>form class</em> and the <em>Qt base class</em>.</p>
</td>
</tr>
</tbody>
</table>
...
<tt class="descclassname">PyQt4.uic.</tt><tt class="descname">loadUi</tt><big>(</big><em>uifile</em><span class="optional">[</span>, <em>baseinstance=None</em><span class="optional">]</span><big>)</big><a class="headerlink" href="#PyQt4.uic.loadUi" title="Permalink to this definition">¶</a></dt>
...
<tr class="field"><th class="field-name">Return type:</th><td class="field-body"><p class="first last">the <tt class="docutils literal"><span class="pre">QWidget</span></tt> sub-class that implements the user interface.</p>
</td>
</tr>
</tbody>
</table>
...
class must sub-class <tt class="docutils literal"><span class="pre">QObject</span></tt> as well as the interface class.  PyQt does
...
<li><p class="first">PyQt installs a C++ plugin in Designer&#8217;s plugin directory.  It conforms to
...
<tt class="file docutils literal"><span class="pre">examples/designer/plugins</span></tt> directory of the PyQt source package.  The
...
<li><a class="reference internal" href="#writing-qt-designer-plugins">Writing Qt Designer Plugins</a></li>
  ...
  <p class="topless"><a href="resources.html"
                        title="next chapter">The PyQt Resource System</a></p>
