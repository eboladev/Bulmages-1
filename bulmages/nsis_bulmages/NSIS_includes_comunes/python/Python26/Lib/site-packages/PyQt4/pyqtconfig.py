...
_pkg_config = {
    'pyqt_bin_dir':      'C:\\Python26\\Lib\\site-packages\\PyQt4',
    'pyqt_config_args':  '--confirm-license -b C:\\Python26\\Lib\\site-packages\\PyQt4',
    ...
    'pyqt_sip_flags':    '-x VendorID -t WS_WIN -x PyQt_Accessibility -x PyQt_NoPrintRangeBug -t Qt_4_8_0 -x Py_v3 -g',
    'pyqt_version':      0x040900,
    'pyqt_version_str':  '4.9',
    'qt_data_dir':       'C:\\Qt\\4.8.0',
    'qt_dir':            'C:\\Qt\\4.8.0',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'C:\\Qt\\4.8.0\\include',
    'qt_lib_dir':        'C:\\Qt\\4.8.0\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040800,
    'qt_winconfig':      'shared'
}
