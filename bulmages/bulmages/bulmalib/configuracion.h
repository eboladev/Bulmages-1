...
/// indica el tama� de la tipografia de la introducci� de aputnes
#define CONF_FONTSIZE_APUNTES 5
/// Indica la fuente de la pantalla de introducci� de apuntes
...
/// Indica si en la introducci� de apuntes debe aparecer el campo de contrapartida.
#define CONF_CONTRAPARTIDA_APUNTES  130
/// Indica si en la introducci� de apuntes debe aparecer la columna de canales
#define CONF_CANAL_APUNTES          131
/// Indica si en la introducci� de apuntes deben aparecer los centros de coste
...
/// Indica en que directorio se encuentran los archivos de traducci�
...
/// Indica cual va a ser el tama� de fuente por defecto
...
/// CONF_NUM_AUT_*		Determina si se utilizar� numeradores automaticos para presupuestos, albaranes y facturas  Inicialmente vale ""
#define CONF_NUM_AUT_PRESUP 500
#define CONF_NUM_AUT_ALBARAN 501
#define CONF_NUM_AUT_FACTURA 502

/// CONF_MOSTRAR_ALMACEN		Determina si se visualizar�el almac� en los listados y si aparecera inhibido en las entradas de datos  Inicialmente vale ""
...
/** Se encarga de recoger todos los parametros de configuraci� de la aplicaci� y los centraliza 
  ...
  * <b>NOTA: tambi� ha adoptado la capacidad de ser un paso de parametros configurables de la aplicaci�. Esto se traduce en que algunos parametros se pueden modificar en tiempo de ejecuci�.</b>
  */
class configuracion {
    private:
...
// Se va a llamar muy a menudo a este objeto en los dem� archivos.
