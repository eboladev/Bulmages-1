...
void Modgenps::formatdigits(QString *cad1,QString *cad2,float x)
{
  ...
  *cad1=tempstr.section('.',0,0);
  cad1->append(',');//Se le a�de a la parte entera la coma (an no s�si dejarlo o no)
}
...
//Psprogressdialog::Psprogressdialog(QString a,QString b,Qt::WFlags max):Q3ProgressDialog(a,b,max) {}
