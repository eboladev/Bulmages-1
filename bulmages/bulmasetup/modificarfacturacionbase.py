...
#
# Created: Sun Feb 22 21:43:30 2009
...
class Ui_ModificarFacturacionBase(object):
    def setupUi(self, ModificarFacturacionBase):
        ...
        self.mui_soporteTPV.setGeometry(QtCore.QRect(309, 60, 208, 23))
        ...
        self.groupBox.setGeometry(QtCore.QRect(4, 88, 513, 58))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(4, 150, 513, 427))
        ...
        self.mui_actualizardatabase.setGeometry(QtCore.QRect(4, 581, 162, 23))
        ...
        self.mui_aceptar.setGeometry(QtCore.QRect(170, 581, 92, 23))
        self.mui_aceptar.setObjectName("mui_aceptar")
        self.mui_hacerbackup = QtGui.QPushButton(ModificarFacturacionBase)
        self.mui_hacerbackup.setGeometry(QtCore.QRect(266, 581, 251, 23))
        self.mui_hacerbackup.setObjectName("mui_hacerbackup")
        self.mui_cancelar = QtGui.QPushButton(ModificarFacturacionBase)
        self.mui_cancelar.setGeometry(QtCore.QRect(521, 581, 275, 23))
        self.mui_cancelar.setObjectName("mui_cancelar")
        self.mui_soporteTPV_2 = QtGui.QCheckBox(ModificarFacturacionBase)
        self.mui_soporteTPV_2.setGeometry(QtCore.QRect(310, 30, 208, 23))
        self.mui_soporteTPV_2.setChecked(False)
        self.mui_soporteTPV_2.setObjectName("mui_soporteTPV_2")
    ...
    def retranslateUi(self, ModificarFacturacionBase):
        ...
        self.mui_actualizardatabase.setText(QtGui.QApplication.translate("ModificarFacturacionBase", "Actualizar Base de Datos (DEbe desaparecer)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.mui_soporteTPV_2.setText(QtGui.QApplication.translate("ModificarFacturacionBase", "Actualizar Base de Datos", None, QtGui.QApplication.UnicodeUTF8))
