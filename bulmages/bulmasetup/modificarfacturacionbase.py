...
#
# Created: Sat Mar 21 12:48:10 2009
...
class Ui_ModificarFacturacionBase(object):
    def setupUi(self, ModificarFacturacionBase):
        ...
        ModificarFacturacionBase.setWindowIcon(QtGui.QIcon(""))
        ...
        self.tab_2.setGeometry(QtCore.QRect(0,0,512,240))
        ...
        self.vboxlayout2.addWidget(self.mui_textBrowser)
