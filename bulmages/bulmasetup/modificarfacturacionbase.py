...
#
# Created: Mon May 11 23:18:53 2009
...
class Ui_ModificarFacturacionBase(object):
    def setupUi(self, ModificarFacturacionBase):
        ...
        self.gridLayout.addWidget(self.mui_aceptar, 5, 0, 1, 1)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/bulmasetup_editarusuario.xpm"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mui_permisos.setIcon(icon5)
        self.mui_permisos.setObjectName("mui_permisos")
        self.gridLayout.addWidget(self.mui_permisos, 5, 1, 1, 2)
        self.mui_hacerbackup = QtGui.QPushButton(ModificarFacturacionBase)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/bulmasetup_save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mui_hacerbackup.setIcon(icon6)
        self.mui_hacerbackup.setObjectName("mui_hacerbackup")
        self.gridLayout.addWidget(self.mui_hacerbackup, 5, 3, 1, 1)
