...
#
# Created: Mon May 18 17:16:10 2009
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.nuevo_usuario.setIconSize(QtCore.QSize(24, 24))
        ...
        self.editar_usuario.setIconSize(QtCore.QSize(24, 24))
        ...
        self.eliminar_usuario.setIconSize(QtCore.QSize(24, 24))
        ...
        self.permisos_usuario.setIconSize(QtCore.QSize(24, 24))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/images/bulmasetup_eliminarempresa.xpm"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayout.addWidget(self.eliminar_empresa, 2, 0, 1, 1)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/images/bulmasetup_empresa.xpm"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mui_adminempresas.setIcon(icon8)
        self.mui_adminempresas.setIconSize(QtCore.QSize(32, 32))
        self.mui_adminempresas.setObjectName("mui_adminempresas")
        self.gridLayout.addWidget(self.mui_adminempresas, 3, 0, 1, 1)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/images/bulmasetup_cargarempresa.xpm"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mui_restbackup.setIcon(icon9)
        self.mui_restbackup.setIconSize(QtCore.QSize(32, 32))
        self.mui_restbackup.setObjectName("mui_restbackup")
        self.gridLayout.addWidget(self.mui_restbackup, 5, 0, 1, 1)
