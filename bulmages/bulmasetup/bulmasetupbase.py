...
#
# Created: Tue May  5 09:12:18 2009
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/bulmasetup_usuario.xpm"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mui_gestionusuarios.setIcon(icon2)
        self.mui_gestionusuarios.setIconSize(QtCore.QSize(48, 48))
        self.mui_gestionusuarios.setObjectName("mui_gestionusuarios")
        self.gridLayout.addWidget(self.mui_gestionusuarios, 0, 2, 1, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/bulmasetup_bulmacont.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mui_crearbulmacont.setIcon(icon3)
        self.mui_crearbulmacont.setIconSize(QtCore.QSize(48, 48))
        self.mui_crearbulmacont.setObjectName("mui_crearbulmacont")
        self.gridLayout.addWidget(self.mui_crearbulmacont, 1, 2, 1, 1)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/bulmasetup_bulmafact.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mui_crearbulmafact.setIcon(icon4)
        self.mui_crearbulmafact.setIconSize(QtCore.QSize(48, 48))
        self.mui_crearbulmafact.setObjectName("mui_crearbulmafact")
        self.gridLayout.addWidget(self.mui_crearbulmafact, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.mui_adminempresas, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.mui_restbackup, 4, 2, 1, 1)
