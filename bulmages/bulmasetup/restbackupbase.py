...
#
# Created: Thu Apr  2 17:13:11 2009
...
class Ui_RestBackupBase(object):
    def setupUi(self, RestBackupBase):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/bulmasetup_cargarempresa.xpm"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        RestBackupBase.setWindowIcon(icon)
