...
#
# Created: Sat Mar  7 19:33:04 2009
...
class Ui_ModificarContabilidadBase(object):
    def setupUi(self, ModificarContabilidadBase):
        ...
        ModificarContabilidadBase.resize(800, 608)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("bulmasetup_bulmacont.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, ModificarContabilidadBase):
        ...
        self.mui_categoria.setItemText(0, QtGui.QApplication.translate("ModificarContabilidadBase", "-- Todas --", None, QtGui.QApplication.UnicodeUTF8))
        self.mui_categoria.setItemText(1, QtGui.QApplication.translate("ModificarContabilidadBase", "Facturacion Generica", None, QtGui.QApplication.UnicodeUTF8))
        self.mui_categoria.setItemText(2, QtGui.QApplication.translate("ModificarContabilidadBase", "Facturacion Avanzada", None, QtGui.QApplication.UnicodeUTF8))
        self.mui_categoria.setItemText(3, QtGui.QApplication.translate("ModificarContabilidadBase", "Asociaciones de Padres de Alumnos", None, QtGui.QApplication.UnicodeUTF8))
        self.mui_categoria.setItemText(4, QtGui.QApplication.translate("ModificarContabilidadBase", "Fabricacion y Trazabilidad", None, QtGui.QApplication.UnicodeUTF8))
        self.mui_categoria.setItemText(5, QtGui.QApplication.translate("ModificarContabilidadBase", "IVA. Incluido", None, QtGui.QApplication.UnicodeUTF8))
        self.mui_categoria.setItemText(6, QtGui.QApplication.translate("ModificarContabilidadBase", "Utilidades Genericas", None, QtGui.QApplication.UnicodeUTF8))
        self.mui_categoria.setItemText(7, QtGui.QApplication.translate("ModificarContabilidadBase", "Utilidades Avanzadas", None, QtGui.QApplication.UnicodeUTF8))
        self.mui_categoria.setItemText(8, QtGui.QApplication.translate("ModificarContabilidadBase", "Experimentales", None, QtGui.QApplication.UnicodeUTF8))
