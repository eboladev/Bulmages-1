...
#
# Created: Mon May 11 23:19:06 2009
...
class Ui_ModificarContabilidadBase(object):
    def setupUi(self, ModificarContabilidadBase):
        ...
        self.gridLayout.addWidget(self.mui_nomempresa, 0, 1, 1, 4)
        ...
        self.gridLayout.addWidget(self.mui_nomdb, 1, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.mui_actualizarDB, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.mui_databaserevision, 2, 1, 1, 3)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/bulmasetup_save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.mui_hacerbackup.setIcon(icon3)
        self.mui_hacerbackup.setObjectName("mui_hacerbackup")
        self.gridLayout.addWidget(self.mui_hacerbackup, 5, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.mui_cancelar, 5, 5, 1, 2)
        ...
        self.gridLayout.addWidget(self.mui_permisos, 5, 1, 1, 3)
