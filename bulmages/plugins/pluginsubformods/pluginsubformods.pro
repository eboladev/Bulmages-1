...
# Adaptado a este plugin por Fco. Javier M. C. <fcojavmc@todo-redes.com>
# Modificado originalmente por Tomeu Borras.
# ----------------------------------------------------------------------
...
unix{
    TARGET = ../../installbulmages/plugins/pluginsubformods
...
TRANSLATIONS += pluginsubformods_es.ts \
                pluginsubformods_ca.ts \
                pluginsubformods_en.ts \
                pluginsubformods_fr.ts \
                pluginsubformods_de.ts \
                pluginsubformods_zz.ts 

SOURCES = pluginsubformods.cpp

HEADERS = pluginsubformods.h
