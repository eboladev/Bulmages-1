...
/** Inserta una compa�a en el QList empresas definido en el di�ogo
  * Crea un objeto QListViewItem para la QListView \ref empresas y rellena sus columnas con los datos pasados al m�odo.
...
/** Realiza la misma acci� que el \ref accept
  */
/*  
