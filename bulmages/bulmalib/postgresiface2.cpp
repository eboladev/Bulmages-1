...
/** \file postgresifac2.cpp
  * Contiene la implementacion de las clases \ref cursor2 y \ref postgresiface2 que proveen acceso a las bases de datos
...
/** \return Devuelve el nombre del campo de una posicion determinada.
