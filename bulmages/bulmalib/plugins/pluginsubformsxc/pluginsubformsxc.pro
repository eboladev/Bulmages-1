...
TRANSLATIONS += pluginsubformsxc_es.ts \
                pluginsubformsxc_ca.ts \
                pluginsubformsxc_en.ts \
                pluginsubformsxc_fr.ts \
                pluginsubformsxc_de.ts \
                pluginsubformsxc_zz.ts 

SOURCES = pluginsubformsxc.cpp

HEADERS = pluginsubformsxc.h
