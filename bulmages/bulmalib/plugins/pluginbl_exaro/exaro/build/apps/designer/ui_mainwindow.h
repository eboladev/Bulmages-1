...
public:
    ...
    void setupUi(QMainWindow *mainWindow)
    {
        ...
        actionUse_OpenGL = new QAction(mainWindow);
        actionUse_OpenGL->setObjectName(QString::fromUtf8("actionUse_OpenGL"));
        actionUse_OpenGL->setCheckable(true);
        QIcon icon28;
        icon28.addFile(QString::fromUtf8(":/images/opengl.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionUse_OpenGL->setIcon(icon28);
        ...
        menuTools->addAction(actionUse_OpenGL);
        ...
        toolBar->addSeparator();
        toolBar->addAction(actionUse_OpenGL);
    ...
    void retranslateUi(QMainWindow *mainWindow)
    {
        ...
        actionUse_OpenGL->setText(QApplication::translate("mainWindow", "Use OpenGL", 0, QApplication::UnicodeUTF8));
