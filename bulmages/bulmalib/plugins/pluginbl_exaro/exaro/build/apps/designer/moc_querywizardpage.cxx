...
const QMetaObject queryWizardPage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_queryWizardPage,
      qt_meta_data_queryWizardPage, 0 }
};
...
int queryWizardPage::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_setupDatabase_clicked(); break;
        case 1: on_addQuery_clicked(); break;
        case 2: on_removeQuery_clicked(); break;
        case 3: on_editName_clicked(); break;
        case 4: on_editQuery_clicked(); break;
        default: ;
        }
        _id -= 5;
    }
