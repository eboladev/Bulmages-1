...
**
** Created: Thu Jun 30 23:57:53 2011
...
const QMetaObject PropertyEditor::PropertyEditor::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_PropertyEditor__PropertyEditor,
      qt_meta_data_PropertyEditor__PropertyEditor, 0 }
};
...
int PropertyEditor::PropertyEditor::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: propertyChanged((*reinterpret_cast< QObject*(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< const QVariant(*)>(_a[3])),(*reinterpret_cast< const QVariant(*)>(_a[4]))); break;
        case 1: objectChanged((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        case 2: setObject((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        case 3: resetProperties(); break;
        default: ;
        }
        _id -= 4;
    }
