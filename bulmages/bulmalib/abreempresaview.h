 ...
 ***************************************************************************/
 /** \file abreempresaview.h
   * Contiene la declaraci� de la clase \ref abreempresaview y sus m�odos.
...
/** @brief  Clase que muestra la lista de empresas para seleccionar aquella con la que se desea trabajar.
  *
  * Esta clase muestra el di�ogo de seleccionar una empresa y espera a que se haga doble click sobre uno de los
  * elementos que contiene, se haga click en aceptar o se de la acci� de cancelar.
  * La ventan siempre se abre en modo modal y detiene la ejecuci� del programa.<BR>
  * Se puede especificar, si es preciso, un tipo de empresas a mostrar (bulmacont o bulmafact) para facilitar la
  * selecci� de elementos.
*/
...
private:
   ...
   /// Almacena el password del usuario que desa acceder a la contabilidad.
    QString password;
    /// Indica  el modo en que opera la ventana. Cerrando la aplicaci� al cancelar o cerrando s�o la ventana. Por defecto es 0 -> cerrar aplicaci�.
    int m_modo;
...
public:
   ...
   /// \brief Inicia las variables m_tipo y m_tipoempresa y carga el archivo para hacer la presentaci�.
...
private:
     /// \brief Inserta una compa�a en el QList empresas definido en el di�ogo
    void insertCompany(QString , QString , QString , QString);

private slots:
    /// \brief Al pulsar el bot� de cancelar se aborta la ejecuci� del programa.
