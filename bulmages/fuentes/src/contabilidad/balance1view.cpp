...
/**
  * @brief SLOT que tras pulsarse sobre el bot� de fecha inicial saca el calendario.
  *
  * Ya que la acci� es la misma que la pulsaci� de la tecla + en el campo de fecha
  * Lo que hace esta funci� es escribir el + en dicho campo y esperar que se active el slot \ref fecha_textChanged
  */
...
/**
  * @brief SLOT que tras pulsarse sobre el bot� de fecha final saca el calendario.
  *
  * Ya que la acci� es la misma que la pulsaci� de la tecla + en el campo de fecha
  * Lo que hace esta funci� es escribir el + en dicho campo y esperar que se active el slot \ref fecha_textChanged
  */
