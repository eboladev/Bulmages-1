...
void diarioview1::presentar() {
    ...
    for(;!cursoraux->eof();cursoraux->siguienteregistro()) {
        ...
        if (cursoraux->valor("idc_coste") != "") {
            ...
            if (!cursorcoste->eof()) {
                m_listado->setItem(i,COL_CCOSTE, new QTableItem1(m_listado, QTableItem::OnTyping,cadaux, modo));
        ...
        if (cursoraux->valor("idcanal") != "") {
            ...
            if (!cursorcanal->eof()) {
                m_listado->setItem(i,COL_CANAL, new QTableItem1(m_listado, QTableItem::OnTyping,cadaux, modo));
        ...
        if (cursoraux->valor("contrapartida") != "") {
            ...
            if (!cursoraux1->eof()) {
                m_listado->setItem(i,COL_CONTRAPARTIDA, new QTableItem1(m_listado, QTableItem::OnTyping,cadaux, modo));
        ...
        m_listado->setItem(i,0, new QTableItem1(m_listado, QTableItem::OnTyping,cadaux, modo));

        cadaux.sprintf("%d",idasiento);
        m_listado->setItem(i,COL_NUMASIENTO, new QTableItem1(m_listado, QTableItem::OnTyping,cadaux, modo));
        m_listado->setText(i,COL_NUMASIENTO,cadaux);

        cadaux.sprintf("%d",ordenasiento);
        m_listado->setItem(i,COL_ORDENASIENTO, new QTableItem1(m_listado, QTableItem::OnTyping,cadaux, modo));
        m_listado->setText(i,COL_ORDENASIENTO,cadaux);

        QTableItem1 *item =   new QTableItem1(m_listado, QTableItem::OnTyping ,cadaux, modo);
        ...
        m_listado->setItem(i,3, new QTableItem1(m_listado, QTableItem::OnTyping,cadaux, modo));
        m_listado->setText(i,3,nomcuenta);

        cadaux.sprintf("%5.2f",debe);
        m_listado->setItem(i,4, new QTableItem1(m_listado, QTableItem::OnTyping,cadaux, modo));
        m_listado->setText(i,4,cadaux);

        cadaux.sprintf("%5.2f",haber);
        m_listado->setItem(i,5, new QTableItem1(m_listado, QTableItem::OnTyping,cadaux, modo));
        m_listado->setText(i,5,cadaux);

        m_listado->setItem(i,6, new QTableItem1(m_listado, QTableItem::OnTyping,cadaux, modo));
