...
/** \brief Constructor de clasee
  ...
  * Tambi� se configura correctamente el objeto listado (que reemplaza al que est�en el formulario
...
/** \brief Se encarga  de inicializar la clase con los parametros que se le han pasado.
  * Esta funci� sirve para que desde fuera se pueda preparar a la clase para presentar un listado predeterminado.
  */
...
/** \brief Se ha cambiado texto de alguna fecha del formulario.
