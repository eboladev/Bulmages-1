...
Bulmages01::~Bulmages01() {
    ...
    //es necesario eliminar la referencia a este objeto, por ejemplo aquï¿½
    //justo antes logeo la salida del usuario (Renï¿½
    ctllog->add
