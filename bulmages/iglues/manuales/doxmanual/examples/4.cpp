/** \file 4.cpp \brief Fichero con clases útiles para automovilistas

Este fichero implementa clases útiles para automovilistas, como son la
...
como el número de ruedas o marchas, 
...
public:
///Devuelve el número de ruedas, sin contar la de recambio
int get_nruedas();
/** \brief Fija el número de ruedas

Aquí va una disertación filosófica de 
...
/** \fn set_nmarchas(int)
¡Leñe, casi se me olvidaba comentar la función 
\ref set_nmarchas, menos mal que \c Doxygen me 
permite poner los comentarios donde me dé la gana!
