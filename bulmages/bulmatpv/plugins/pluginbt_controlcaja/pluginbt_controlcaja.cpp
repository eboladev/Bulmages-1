...
#include "pluginbt_controlcaja.h"
#include "btcompany.h"
#include "admin.h"
#include "blplugins.h"
#include "btticket.h"
...
int entryPoint ( BtBulmaTPV *tpv )
{
    ...
    setlocale ( LC_ALL, "" );
    blBindTextDomain ( "pluginbt_controlcaja", g_confpr->value( CONF_DIR_TRADUCCION ).toAscii().constData() );
...
{
    BlDebug::blDebug ( "PluginBt_ControlCaja::exitPoint", 0 );
    delete g_admin;
