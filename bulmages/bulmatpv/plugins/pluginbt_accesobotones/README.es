...
Biblioteca: libpluginbt_accesobotones.so

Descripción: <H1>Acceso rápido</H1>
<P>Con este plugin BulmaTPV adquiere la posibilidad de tener trabajando múltiples trabajadores.
