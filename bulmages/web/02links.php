            ...
            <td><table border="0" align="center" cellpadding="0" cellspacing="0">
                <tr valign="top"> 
                  ...
                  <td height="53" bgcolor="#FFFFFF"> <table width="100%" border="0" cellpadding="3" cellspacing="0" dwcopytype="CopyTableRow">
                      <tr> 
                        <td><font color="#FF9966" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>About 
                          BulmaGes</strong></font></td>
                      </tr>
                      <tr> 
                        <td><a href="http://bulmages.bulma.net/mailman/listinfo/bulmages_bulmages.bulma.net" target="_blank"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">BulmaG&eacute;s 
                      ...
                      <tr>
                        <td><a href="http://www.burcion.com/bulmages.htm" target="_blank"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Josep
                              Burci&oacute;n's Web </FONT></a></td>
                      </tr>
                      <tr> 
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font color="#FF9966" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Related 
