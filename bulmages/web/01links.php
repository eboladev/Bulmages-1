                  ...
                  <td height="53" bgcolor="#FFFFFF"> <table width="100%" border="0" cellpadding="3" cellspacing="0" dwcopytype="CopyTableRow">
                      ...
                      <tr> 
                        <td><a href="http://bulmalug.net/" target="_blank"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Bulma: 
                          Bergantells Usuaris de Linux de Mallorca i Afegitons</font></a></td>
                      </tr>
                      <tr>
                        <td><a href="http://www.burcion.com/bulmages.htm" target="_blank"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">P&agrave;gina
                              de Josep Burci&oacute;n </FONT></a></td>
                      </tr>
                      <tr> 
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                      <tr> 
                        <td><font color="#FF9966" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Projectes Relacionats:</strong></font></td>
                      </tr>
                      <tr> 
