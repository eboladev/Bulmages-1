...
TarifaView::TarifaView(company *comp, QWidget *parent, const char *name)
    ...
    addDBCampo("idtarifa", DBCampo::DBint, DBCampo::DBPrimaryKey, "Identificador");
    addDBCampo("nomtarifa", DBCampo::DBvarchar, DBCampo::DBNotNull, "Nombre Tarifa");
...
void TarifaView::closeEvent( QCloseEvent *e) {
    ...
    if (dialogChanges_hayCambios())  {
        int val = QMessageBox::warning( this, "Guardar Tarifa",
