...
void orderslist::inicializa() {
    ...
    m_list->horizontalHeader()->setLabel( COL_ANOPEDIDO, tr( "A�" ) );
    m_list->horizontalHeader()->setLabel( COL_FECHAPEDIDO, tr( "Fecha Emisi�" ) );
    m_list->horizontalHeader()->setLabel( COL_DESCPEDIDO, tr( "Descripci�" ) );
    m_list->horizontalHeader()->setLabel( COL_IDDIVISION, tr( "Proveedor/Divisi�" ) );
    m_list->horizontalHeader()->setLabel( COL_IDALMACEN, tr( "Almac�" ) );
