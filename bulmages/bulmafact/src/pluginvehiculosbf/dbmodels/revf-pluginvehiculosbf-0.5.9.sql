...
BEGIN
	...
	IF FOUND THEN
		UPDATE CONFIGURACION SET valor = ''0.5.9'' WHERE nombre = ''DBRev-PluginVehiculosBF'';
	ELSE
		INSERT INTO configuracion (nombre, valor) VALUES (''DBRev-DBRev-PluginVehiculosBF'', ''0.5.9''); 		 
	END IF;
	RETURN 0;
END;
' LANGUAGE plpgsql;
