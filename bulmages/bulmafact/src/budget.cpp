...
// Inicializamos la tabla de descuentos del presupuesto
	...
	m_listDiscounts->horizontalHeader()->setLabel( COL_DESCUENTO_PROPORCIONDPRESUPUESTO, tr( "Proporci�" ) );
...
// Carga l�eas descuentos presupuesto
...
void Budget::buscarAlmacen() {
	QMessageBox::warning( this, "BulmaFact - Presupuestos", "Aun no est�implementado.", "Si", "No");
