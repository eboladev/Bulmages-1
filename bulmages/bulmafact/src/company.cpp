...
void company::createMainWindows() {
    m_articleslist = new articleslist(this, m_pWorkspace,theApp->translate("Art�ulos","company"));
...
void company::newClient() {
    m_clientEdit = new ClientEdit(this, m_pWorkspace,theApp->translate("Editar/A�dir cliente","company"));
    m_clientEdit->hide();
