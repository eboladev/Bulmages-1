...
-- NumCompra: Numero de Compra (Clau artificial per poder registrar recepcions que ens arribin sense l'albarán postposant la cumplimentación del nmero d'albarán.
-- NumAlbara: Nmero d'albarán
-- Data: Data de l'albarán-- Recepcio: Data de recepción
-- Comentaris
...
void delivnoteslist::inicializa() {
   ...
   m_list->horizontalHeader()->setLabel( COL_NALBALB_PRO, tr( "N Albarán" ) );
