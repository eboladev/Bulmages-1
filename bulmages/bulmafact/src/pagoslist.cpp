...
-- hacemos a petición de un proveedor determinado
-- Numero
...
void PagosList::imprimir() {
    ...
    QString SQLQuery = "SELECT * FROM presupuesto, proveedor, almacen where presupuesto.idproveedor=proveedor.idproveedor AND presupuesto.idalmacen=almacen.idalmacen "+generaFiltro();
