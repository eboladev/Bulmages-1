...
providerslist::providerslist(company *comp, QWidget *parent, const char *name, int flag)
 : providerslistbase(parent, name, flag) {
   ...
   m_list->horizontalHeader()->setLabel( COL_IDPROVEEDOR, tr( "C�igo" ) );
   ...
   m_list->horizontalHeader()->setLabel( COL_CODICLIPROVEEDOR, tr( "C�igo de cliente" ) );
   ...
   m_list->horizontalHeader()->setLabel( COL_POBLPROVEEDOR, tr("Poblaci�") );
   m_list->horizontalHeader()->setLabel( COL_CPPROVEEDOR, tr("C.P.") );
   m_list->horizontalHeader()->setLabel( COL_TELPROVEEDOR, tr("N Tel�ono") );
   m_list->horizontalHeader()->setLabel( COL_FAXPROVEEDOR, tr("N Fax") );
   m_list->horizontalHeader()->setLabel( COL_EMAILPROVEEDOR, tr("Correo Electr�ico") );
   m_list->horizontalHeader()->setLabel( COL_URLPROVEEDOR, tr("P�ina Web") );
