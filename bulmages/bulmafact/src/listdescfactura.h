...
public:
	...
	Q3PtrList<DescuentoFactura> m_lista;
...
public:
	...
	{
		_depura("ListDescuentoFactura setCompany.", 0);
		companyact = c;
		_depura("ListDescuentoFactura fin de setCompany.", 0);
	};
	void guardaListDescuentoFactura();
	void vaciar();
	virtual void pintaListDescuentoFactura()
	{
		_depura("La funcion pintaListDescuentoFactura aun no ha sido implementada.", 0);
	};
