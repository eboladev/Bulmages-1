...
private:
    ...
    bool m_semaforo;
public:
    BusquedaReferencia(QWidget *parent = 0, const char *name = 0);
    ~BusquedaReferencia();
    void setcompany(company *comp) {m_companyact = comp;};
    virtual void setText(QString val) {mui_referencia->setText(val);};
    virtual QString text(){return mui_referencia->text();};
public slots:
