...
{
    blDebug ( "BfForm::calculaypintatotales", 0 );
...
{
    blDebug ( "BfForm::trataLineasDetalle", 0 );
...
{
    blDebug ( "BfForm::trataLineasDescuento", 0 );
...
{
    blDebug ( "BfForm::setListaLineas", 0 );
...
{
    blDebug ( "BfForm::setListaDescuentos", 0 );
