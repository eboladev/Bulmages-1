...
void Factura::imprimirFactura() {
    ...
    archivo = "cp "+archivo+" /tmp/facturacliente.rml";
    ...
    QFile file;
    file.setName( "/tmp/facturacliente.rml" );
    ...
    system("trml2pdf.py /tmp/facturacliente.rml > /tmp/facturacliente.pdf");
    system("kpdf /tmp/facturacliente.pdf &");
