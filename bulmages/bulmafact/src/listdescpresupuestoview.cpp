...
ListDescuentoPresupuestoView::ListDescuentoPresupuestoView(QWidget * parent, const char * name) : QTable(parent, name), ListDescuentoPresupuesto() {
    /// Inicializamos la tabla de lineas de presupuesto
    setNumCols(4);
    setNumRows(100);
    horizontalHeader()->setLabel( COL_IDDPRESUPUESTO, tr( "N L�ea" ) );
