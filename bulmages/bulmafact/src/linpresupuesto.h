...
/// Muestra y administra una l&iacute;nea de detalle del un presupuesto.
/** */
...
public:
    ...
    /// La carga r&aacute;pida tiene un comportamiento poco restrictivo para aumentar
    /// la eficiencia.
    ...
    /// Estas funciones no est&aacute;n como debe, el uso de cada una de ellas debe hacer
    /// cambios sobre la base de datos.
    void setidarticulo(QString);
    inline void setnomarticulo(QString val) {
        setDBvalue("nomarticulo", val);
    };
    /// Hace el c&aacute;lculo de la base imponible de la l&iacute;nea.
    float calculabase();
    /// Hace el c&aacute;lculo del IVA de la l&iacute;nea.
    float calculaiva();
};
