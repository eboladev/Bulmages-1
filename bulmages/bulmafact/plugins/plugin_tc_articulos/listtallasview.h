...
#ifndef LISTTALLASVIEW_H
#define LISTTALLASVIEW_H
...
/** */
class ListTallasSubForm : public SubForm2Bf
{
    Q_OBJECT

public:
    ListTallasSubForm ( QWidget *parent = 0 );
    virtual ~ListTallasSubForm() {};
...
/** */
class ListTallasView : public FichaBf, public Ui_ListTallasBase
{
    Q_OBJECT
