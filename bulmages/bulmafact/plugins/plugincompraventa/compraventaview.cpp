        ...
        : FichaBf ( comp, parent )
{
	...
	m_albaranp->setDBTableName("albaranp");
        ...
        m_albaranp->addDBCampo ( "idalbaranp", DBCampo::DBint, DBCampo::DBPrimaryKey, _( "Id albaran proveedor" ) );
        m_albaranp->addDBCampo ( "numalbaranp", DBCampo::DBint, DBCampo::DBNothing, _( "Numero albaran proveedor" ) );
        m_albaranp->addDBCampo ( "fechaalbaranp", DBCampo::DBdate, DBCampo::DBNothing, _( "Fecha albaran proveedor" ) );
        m_albaranp->addDBCampo ( "comentalbaranp", DBCampo::DBvarchar, DBCampo::DBNothing, _( "Comentario albaran proveedor" ) );
        m_albaranp->addDBCampo ( "idproveedor", DBCampo::DBint, DBCampo::DBNotNull, _( "Id proveedor" ) );
        m_albaranp->addDBCampo ( "idforma_pago", DBCampo::DBint, DBCampo::DBNothing, _( "Id forma de pago" ) );
        m_albaranp->addDBCampo ( "idalmacen", DBCampo::DBint, DBCampo::DBNotNull, _( "Id almacen" ) );
        m_albaranp->addDBCampo ( "refalbaranp", DBCampo::DBvarchar, DBCampo::DBNothing, _( "Referencia albaran proveedor" ) );
        m_albaranp->addDBCampo ( "descalbaranp", DBCampo::DBvarchar, DBCampo::DBNothing, _( "Descripcion albaran proveedor" ) );
