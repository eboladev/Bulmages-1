...
#define NUMDIGITOS   g_confpr->value(CONF_CONT_NUMDIGITOSEMPRESA).toInt()
...
\param flag
**/
BcCambiaCuentaView::BcCambiaCuentaView ( BfCompany *emp, QWidget *parent, Qt::WindowFlags flag )
