        ...
        : BfForm ( emp, parent, fl )
{
    ...
    mui_idc_coste->setMainCompany ( mainCompany() );
    mui_idc_coste->setQuery ( "SELECT * FROM c_coste ORDER BY codigo" );
    mui_idc_coste->setTableName ( "c_coste" );
    mui_idc_coste->setFieldId ( "idc_coste" );
    mui_idc_coste->m_valores["codigo"] = "";
    mui_idc_coste->m_valores["nombre"] = "";
    mui_idc_coste->setId ( "" );
