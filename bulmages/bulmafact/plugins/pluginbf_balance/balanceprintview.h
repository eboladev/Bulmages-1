...
*/
class BalancePrintView : public BfForm, public Ui_BalancePrintBase
//, public BlMainCompanyPointer
{
    Q_OBJECT

public:
    BalancePrintView ( BfCompany *emp, QWidget *parent = 0, int flags = 0 );
    ~BalancePrintView();
...
private slots:
    /// No usar mui_imprimir para no confundirlo con BfForm.
