...
\param date
**/
void CuadranteDiarioView::on_mui_calendario_released ( const QDate &date )
{
    _depura ( "CuadranteDiarioView::on_mui_calendario_released", 0, date.toString ( "dd/MM/yyyy" ) );
...
/**
**/
void CuadranteDiarioView::on_mui_editar_released()
{
...
/**
**/
void CuadranteDiarioView::on_mui_actualizar_released()
{
    _depura ( "CuadranteDiarioView::on_mui_actualizar_released", 0 );
    inicializaTrabajadores();
    inicializaCuadrante ( mui_calendario->selectedDate() );
    _depura ( "CuadranteDiarioView::on_mui_actualizar_released", 0 );
}
...
/**
**/
void CuadranteDiarioView::on_mui_limpiar_released()
{
    _depura ( "CuadranteDiarioView::on_mui_limpiar_released", 0 );
...
/**
**/
void CuadranteDiarioView::on_mui_duplicar_released()
{
    _depura ( "CuadranteDiarioView::on_mui_limpiar_released", 0 );
...
/**
**/
void CuadranteDiarioView::on_mui_imprimir_released()
{
    _depura ( "CuadranteDiarioView::on_mui_imprimir_released", 0 );
...
//    QDate date = mui_calendario->selectedDate().addDays(-mui_calendario->selectedDate().dayOfWeek() + 1);
    ...
    invocaPDF ( "cuadrante" );
    _depura ( "END CuadranteDiarioView::on_mui_imprimir_released", 0 );
