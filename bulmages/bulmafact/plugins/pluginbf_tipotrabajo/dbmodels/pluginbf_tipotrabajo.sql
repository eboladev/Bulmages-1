...
DECLARE
	as RECORD;
BEGIN
	SELECT INTO as * FROM configuracion WHERE nombre=''PluginBf_TipoTrabajo'';
	IF FOUND THEN
		UPDATE CONFIGURACION SET valor=''0.10.1-0001'' WHERE nombre=''PluginBf_TipoTrabajo'';
	ELSE
		INSERT INTO configuracion (nombre, valor) VALUES (''PluginBf_TipoTrabajo'', ''0.10.1-0001'');
	END IF;
	RETURN 0;
END;
'   LANGUAGE plpgsql;
