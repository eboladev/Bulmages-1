...
RutaComercialListSubForm::RutaComercialListSubForm ( QWidget *parent ) : SubForm2Bf ( parent )
{
    ...
    addSHeader ( "cifcliente", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "CIF del cliente" ) );
    addSHeader ( "nomcliente", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Nombre del cliente" ) );
    addSHeader ( "idzonacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoView | BlSubFormHeader::DBNoWrite, _( "ID zona comercial" ) );
    addSHeader ( "fecharutacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Fecha ruta comercial" ) );
    addSHeader ( "fechaincidenciacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Fecha incidencia comercial" ) );
    addSHeader ( "nomtrabajador", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Nombre del trabajador" ) );
    addSHeader ( "apellidostrabajador", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Apellidos del trabajador" ) );
    addSHeader ( "idcliente", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoView | BlSubFormHeader::DBNoWrite, _( "ID cliente" ) );
    addSHeader ( "idtrabajador", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoView | BlSubFormHeader::DBNoWrite, _( "ID trabajador" ) );
    addSHeader ( "idrutacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoView | BlSubFormHeader::DBNoWrite, _( "ID ruta comercial" ) );
    addSHeader ( "comentariosrutacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Comentarios ruta comercial" ) );
    addSHeader ( "idincidenciacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoView | BlSubFormHeader::DBNoWrite, _( "ID incidencia comercial" ) );
    addSHeader ( "comentincidenciacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Comentario de la incidencia comercial" ) );
    addSHeader ( "estadoincidenciacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Estado de la incidencia comercial" ) );
    addSHeader ( "idpedidocliente", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoView | BlSubFormHeader::DBNoWrite, _( "ID pedido cliente" ) );
    addSHeader ( "idcobro", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNoView | BlSubFormHeader::DBNoWrite, _( "ID cobro" ) );
    addSHeader ( "nomzonacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Nombre zona comercial" ) );
    addSHeader ( "refrutacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Referencia ruta" ) );
    addSHeader ( "horarutacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Hora ruta" ) );
    addSHeader ( "refincidenciacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Referencia de la incidencia" ) );
    addSHeader ( "horaincidenciacomercial", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Hora de la incidencia" ) );
    setinsercion ( FALSE );
