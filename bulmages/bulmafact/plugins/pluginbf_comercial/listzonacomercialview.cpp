...
ListZonaComercialSubForm::ListZonaComercialSubForm ( QWidget *parent ) : SubForm2Bf ( parent )
{
    ...
    addSHeader ( "idzonacomercial", DBCampo::DBint, DBCampo::DBPrimaryKey, BlSubFormHeader::DBNoView, _( "ID zona comercial" ) );
    addSHeader ( "nomzonacomercial", DBCampo::DBvarchar, DBCampo::DBNotNull, BlSubFormHeader::DBNone, _( "Nombre de la zona comercial" ) );
    setinsercion ( TRUE );
