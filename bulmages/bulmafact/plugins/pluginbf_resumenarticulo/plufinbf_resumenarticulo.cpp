...
{
    blDebug ( "Punto de Entrada del plugin de Resumen de Articulos\n", 0 );

    /// Inicializa el sistema de traducciones 'gettext'.
    setlocale ( LC_ALL, "" );
    blBindTextDomain ( "pluginbf_resumenarticulo", g_confpr->valor ( CONF_DIR_TRADUCCION ).toAscii().constData() );
