...
*/
class PLUGINBF_ASOCIACION_EXPORT ConvReunionListSubForm : public BfSubForm
{
    Q_OBJECT
...
class PLUGINBF_ASOCIACION_EXPORT ConvReunionList : public BlFormList, public Ui_ConvReunionListBase
{
    Q_OBJECT
...
public:
    ConvReunionList ( QWidget *parent = 0, Qt::WindowFlags flag = 0, edmode editmodo = BL_EDIT_MODE );
    ConvReunionList ( BfCompany *comp = NULL, QWidget *parent = 0, Qt::WindowFlags flag = 0, edmode editmodo = BL_EDIT_MODE );
    ~ConvReunionList();
    void presentar();
