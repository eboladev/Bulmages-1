...
MovimientosSubform::MovimientosSubform ( QWidget *parent, const char * ) : SubForm2Bf ( parent )
{
    ...
    addSHeader ( "idmovimiento", DBCampo::DBint, DBCampo::DBPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "idarticulo" ) );
    addSHeader ( "fechamovimiento", DBCampo::DBdate, DBCampo::DBNotNull, BlSubFormHeader::DBNone , _( "Fecha" ) );
    addSHeader ( "idarticulo", DBCampo::DBint, DBCampo::DBNotNull, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Id articulo" ) );
    addSHeader ( "codigocompletoarticulo", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Codigo articulo" ) );
    addSHeader ( "nomarticulo", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Nombre articulo" ) );
    addSHeader ( "cantidadmovimiento", DBCampo::DBnumeric, DBCampo::DBNotNull, BlSubFormHeader::DBNone , _( "Cantidad" ) );
    addSHeader ( "lotemovimiento", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "Lote" ) );
    addSHeader ( "idalmacen", DBCampo::DBint, DBCampo::DBNotNull, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Id almacen" ) );
    addSHeader ( "codigoalmacen", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Codigo almacen" ) );
    addSHeader ( "nomalmacen", DBCampo::DBvarchar, DBCampo::DBNothing, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Nombre almacen" ) );
    addSHeader ( "idlalbaran", DBCampo::DBint, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "Id albaran cliente" ) );
    addSHeader ( "idlalbaranp", DBCampo::DBint, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "Id albaran proveedor" ) );
