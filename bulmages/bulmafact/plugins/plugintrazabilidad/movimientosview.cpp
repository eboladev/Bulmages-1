...
MovimientosSubform::MovimientosSubform ( QWidget *parent, const char * ) : SubForm2Bf ( parent )
{
    ...
    addSHeader ( "idmovimiento", BlDbField::DBint, BlDbField::DBPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "idarticulo" ) );
    addSHeader ( "fechamovimiento", BlDbField::DBdate, BlDbField::DBNotNull, BlSubFormHeader::DBNone , _( "Fecha" ) );
    addSHeader ( "idarticulo", BlDbField::DBint, BlDbField::DBNotNull, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Id articulo" ) );
    addSHeader ( "codigocompletoarticulo", BlDbField::DBvarchar, BlDbField::DBNothing, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Codigo articulo" ) );
    addSHeader ( "nomarticulo", BlDbField::DBvarchar, BlDbField::DBNothing, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Nombre articulo" ) );
    addSHeader ( "cantidadmovimiento", BlDbField::DBnumeric, BlDbField::DBNotNull, BlSubFormHeader::DBNone , _( "Cantidad" ) );
    addSHeader ( "lotemovimiento", BlDbField::DBvarchar, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "Lote" ) );
    addSHeader ( "idalmacen", BlDbField::DBint, BlDbField::DBNotNull, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Id almacen" ) );
    addSHeader ( "codigoalmacen", BlDbField::DBvarchar, BlDbField::DBNothing, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Codigo almacen" ) );
    addSHeader ( "nomalmacen", BlDbField::DBvarchar, BlDbField::DBNothing, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Nombre almacen" ) );
    addSHeader ( "idlalbaran", BlDbField::DBint, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "Id albaran cliente" ) );
    addSHeader ( "idlalbaranp", BlDbField::DBint, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "Id albaran proveedor" ) );
