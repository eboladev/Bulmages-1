        ...
        : SubForm2Bf ( parent )
{
    ...
    addSHeader ( "punteocontrolstock", DBCampo::DBboolean, DBCampo::DBNothing, BlSubFormHeader::DBNone, _( "Punteado" ) );
    addSHeader ( "codigoalmacen", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone, _( "Codigo almacen" ) );
    ...
    addSHeader ( "codigocompletoarticulo", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Codigo completo articulo" ) );
    ...
    addSHeader ( "stockantcontrolstock", DBCampo::DBnumeric, DBCampo::DBNothing, BlSubFormHeader::DBNoWrite, _( "Stock anterior" ) );
    addSHeader ( "stocknewcontrolstock", DBCampo::DBnumeric, DBCampo::DBRequired, BlSubFormHeader::DBNone, _( "Stock revisado" ) );
    addSHeader ( "idarticulo", DBCampo::DBint, DBCampo::DBPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView, _( "Id articulo" ) );
    addSHeader ( "idalmacen", DBCampo::DBint, DBCampo::DBPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView, "Id almacen" );
    addSHeader ( "idinventario", DBCampo::DBint, DBCampo::DBPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView, "Id inventario" );
    addSHeader ( "idarticulopk", DBCampo::DBint, DBCampo::DBNoSave | DBCampo::DBDupPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView | BlSubFormHeader::DBBlockView, "idarticulo" );
    addSHeader ( "idalmacenpk", DBCampo::DBint,  DBCampo::DBNoSave | DBCampo::DBDupPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView | BlSubFormHeader::DBBlockView, "idalmacen" );
//    addSHeader("idinventariopk", DBCampo::DBint,  DBCampo::DBNoSave | DBCampo::DBDupPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView | BlSubFormHeader::DBBlockView, "idinventario");
    setinsercion ( FALSE );
