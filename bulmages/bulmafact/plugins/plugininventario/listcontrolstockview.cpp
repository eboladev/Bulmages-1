        ...
        : BfSubForm ( parent )
{
    ...
    addSHeader ( "punteocontrolstock", BlDbField::DBboolean, BlDbField::DBNothing, BlSubFormHeader::DBNone, _( "Punteado" ) );
    addSHeader ( "codigoalmacen", BlDbField::DBvarchar, BlDbField::DBNoSave, BlSubFormHeader::DBNone, _( "Codigo almacen" ) );
    ...
    addSHeader ( "codigocompletoarticulo", BlDbField::DBvarchar, BlDbField::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Codigo completo articulo" ) );
    ...
    addSHeader ( "stockantcontrolstock", BlDbField::DBnumeric, BlDbField::DBNothing, BlSubFormHeader::DBNoWrite, _( "Stock anterior" ) );
    addSHeader ( "stocknewcontrolstock", BlDbField::DBnumeric, BlDbField::DBRequired, BlSubFormHeader::DBNone, _( "Stock revisado" ) );
    addSHeader ( "idarticulo", BlDbField::DBint, BlDbField::DBPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView, _( "Id articulo" ) );
    addSHeader ( "idalmacen", BlDbField::DBint, BlDbField::DBPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView, "Id almacen" );
    addSHeader ( "idinventario", BlDbField::DBint, BlDbField::DBPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView, "Id inventario" );
    addSHeader ( "idarticulopk", BlDbField::DBint, BlDbField::DBNoSave | BlDbField::DBDupPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView | BlSubFormHeader::DBBlockView, "idarticulo" );
    addSHeader ( "idalmacenpk", BlDbField::DBint,  BlDbField::DBNoSave | BlDbField::DBDupPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView | BlSubFormHeader::DBBlockView, "idalmacen" );
//    addSHeader("idinventariopk", BlDbField::DBint,  BlDbField::DBNoSave | BlDbField::DBDupPrimaryKey, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoView | BlSubFormHeader::DBBlockView, "idinventario");
    setinsercion ( FALSE );
