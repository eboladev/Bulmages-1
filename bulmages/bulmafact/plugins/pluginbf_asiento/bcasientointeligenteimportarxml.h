...
/** Esta clase es un analizador (parser) XML cuya funci&oacute;n es importar a la base
    ...
    SAX de Qt. */
class PLUGINBF_ASIENTO_EXPORT BcAsientoInteligenteImportarXML: public QXmlDefaultHandler, public BlMainCompanyPointer
{
private:
...
public:
    ...
    BcAsientoInteligenteImportarXML ( BfCompany * );
