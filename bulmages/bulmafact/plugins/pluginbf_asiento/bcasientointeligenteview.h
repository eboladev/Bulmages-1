...
*/
class PLUGINBF_ASIENTO_EXPORT BcAsientoInteligenteView : public BfForm, public Ui_BcAsientoInteligenteBase
{
    Q_OBJECT
...
public:
    BcAsientoInteligenteView ( BfCompany *, QWidget *parent = 0 );
