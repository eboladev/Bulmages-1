...
class PLUGINBF_ASIENTO_EXPORT BcAsientoList : public BcAsientoForm
{
    Q_OBJECT
...
public:
    BcAsientoList ( BfCompany *, QWidget *parent );
...
class PLUGINBF_ASIENTO_EXPORT BcAsientoView : public BcAsientoList, public Ui_BcAsientoBase
{
    Q_OBJECT
...
public:
    BcAsientoView ( BfCompany *, QWidget *parent = 0, int flags = 0 );
    ~BcAsientoView();
