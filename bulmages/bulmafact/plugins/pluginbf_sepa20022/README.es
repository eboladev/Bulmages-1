...
Nombre: Remesas bancarias SEPA 20022

Biblioteca: libpluginbf_sepa20022.so

Descripción: <H1>Remesas Bancaria (Protocolo SEPA)</H1>
<P>Agrega un botón de generacion de remesas bancarias al listado de facturas. Funciona en conjuncion con el plugin de impresionesmultiples y al seleccionar varias facturas o cobros y darle a este botón genera el archivXML SEPA para poder pasarlo al banco. El codigo de referencia y devolución los genera como el id de bd con una F añadida al final para las facturas (para no duplicar código si un cobro y una factura tienen el mismo id, luego no sabríamos cuál nos  ha devuelto el banco. ver https://lists.berlios.de/pipermail/bulmages-main/2009-February/000935.html</P>
