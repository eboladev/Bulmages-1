...
#include "sepa20022qtoolbutton.h"
...
\param parent
**/
Sepa20022QToolButton::Sepa20022QToolButton ( CobrosList *cob , QWidget *parent ) : QToolButton ( parent )
{
    BL_FUNC_DEBUG
    m_cobrosList = cob;
    m_recibosList=NULL;
    m_q19 = new Sepa20022Writer( (BfCompany *) cob->mainCompany());
    setBoton();
...
\param parent
**/
Sepa20022QToolButton::Sepa20022QToolButton ( RecibosList *cob , QWidget *parent ) : QToolButton ( parent )
{
    BL_FUNC_DEBUG
    m_recibosList = cob;
    m_cobrosList = NULL;
...
/**
**/
Sepa20022QToolButton::~Sepa20022QToolButton()
{
    BL_FUNC_DEBUG
     delete m_q19;
...
/**
**/
void Sepa20022QToolButton::setBoton()
{
    BL_FUNC_DEBUG
    connect ( this, SIGNAL ( clicked() ), this, SLOT ( click() ) );
    setObjectName ( QString::fromUtf8 ( "exporta" ) );
    setStatusTip ( _("Generar SEPA20022") );
    setToolTip ( _("Generar archivo SEPA de los elementos seleccionados.") );
...
\return
**/
void Sepa20022QToolButton::click()
{
    BL_FUNC_DEBUG
    BlSubForm *sub = NULL;
    if (m_cobrosList) {
