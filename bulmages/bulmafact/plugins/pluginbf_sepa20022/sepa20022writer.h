...
class Sepa20022Writer : public QObject
{
...
protected:
	...
	**/
	...
	int cobroSepa20022 ( QTextStream &out, QString sufijo,   BlDbRecordSet *curcobro );
...
fitxer sepa20022. Per'o si hi ha alguna excepcio interna per dades incorrectes, treu
