...
Reports: presupuesto_ticket.txt; pedido_ticket.txt; albaran_ticket.txt; factura_ticket.txt; impers_factura.txt; impers_presupuesto.txt; impers_pedido.txt; impers_albaran.txt
