...
ListLTarifaView::ListLTarifaView ( QWidget *parent ) : SubForm2Bf ( parent )
{
    ...
    addSHeader ( "nomtarifa", DBCampo::DBvarchar, DBCampo::DBNoSave, SHeader::DBNone | SHeader::DBNoWrite, _( "Nombre tarifa" ) );
    addSHeader ( "nomalmacen", DBCampo::DBvarchar, DBCampo::DBNoSave, SHeader::DBNone | SHeader::DBNoWrite, _( "Nombre almacen" ) );
    addSHeader ( "pvpltarifa", DBCampo::DBnumeric, DBCampo::DBRequired, SHeader::DBNone, _( "Precio de venta" ) );
