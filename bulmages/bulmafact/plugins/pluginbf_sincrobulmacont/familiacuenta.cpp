...
{
    _depura ( "FamiliaCuenta::FamiliaCuenta", 1 );
    ...
    _depura ( "END FamiliaCuenta::FamiliaCuenta", 1 );
}
...
{
    _depura ( "FamiliaCuenta::~FamiliaCuenta", 0 );
    _depura ( "END FamiliaCuenta::~FamiliaCuenta", 0 );
}
