...
ClienteCuenta::ClienteCuenta (QWidget *parent) : QWidget(parent)
{
    ...
    lineedit_cliente->setStatusTip("Sobreescribe la configuracion por defecto para la cuenta contable de este cliente. La cuenta debe existir en la contabilidad.");
    QLabel *label_cliente = new QLabel("Cuenta contable:");
