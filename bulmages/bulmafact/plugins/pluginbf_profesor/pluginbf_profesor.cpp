...
int entryPoint ( Bulmafact *bges )
{
    ...
    setlocale(LC_ALL, "");
    bindtextdomain ("pluginbf_profesor", confpr->valor(CONF_DIR_TRADUCCION).toAscii().constData());
...
int Busqueda_on_mui_buscar_clicked(BlSearchWidget *busq) {
    ...
    ProfesoresList *clients = new ProfesoresList ( ( BfCompany * ) busq->mainCompany(), diag, 0, ProfesoresList::SelectMode );
