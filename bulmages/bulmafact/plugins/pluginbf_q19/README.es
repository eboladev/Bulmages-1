...
<P>Agrega un botón de generacion de remesas bancarias al listado de facturas. Funciona en conjuncion con el plugin de impresionesmultiples y al seleccionar varias facturas y darle a este botón genera el archivo q19 para poder pasarlo al banco. El codigo de referencia y devolución los genera como el id de bd con una F añadida al final para las facturas (para no duplicar código si un cobro i una factura tienen el mismo id, luego no sabríamos cuál nos  ha devuelto el banco. ver https://lists.berlios.de/pipermail/bulmages-main/2009-February/000935.html</P>
