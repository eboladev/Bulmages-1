...
ContratosListSubform::ContratosListSubform ( QWidget *parent, const char * ) : SubForm2Bf ( parent )
{
    ...
    addSHeader ( "idcontrato", DBCampo::DBint, DBCampo::DBNotNull | DBCampo::DBPrimaryKey, BlSubFormHeader::DBNoView | BlSubFormHeader::DBNoWrite, _( "ID contrato" ) );
    ...
    addSHeader ( "refcontrato", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Referencia" ) );
    addSHeader ( "nomcontrato", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Nombre de contrato" ) );
    addSHeader ( "nomcliente", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Nombre alternativo del contrato" ) );
    addSHeader ( "fincontrato", DBCampo::DBdate, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Fecha de alta del contrato" ) );
    addSHeader ( "ffincontrato", DBCampo::DBdate, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Fecha de baja del contrato" ) );
    addSHeader ( "periodicidadcontrato", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Fecha de baja del contrato" ) );
    setinsercion ( FALSE );
    setDelete ( FALSE );
