...
ListLinContratoView::ListLinContratoView ( QWidget *parent ) : BfSubForm ( parent )
{
    ...
    addSubFormHeader ( "idlcontrato", BlDbField::DBint, BlDbField::DBPrimaryKey, BlSubFormHeader::DBNoView, _( "Idl contrato" ) );
    ...
    addSubFormHeader ( "idcontrato", BlDbField::DBint, BlDbField::DBNotNull, BlSubFormHeader::DBNoView, _( "Id contrato" ) );
    addSubFormHeader ( "ordenlcontrato", BlDbField::DBint, BlDbField::DBNotNull, BlSubFormHeader::DBNoView, _( "Orden" ) );
    setinsercion ( TRUE );
