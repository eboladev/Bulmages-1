...
ListLinContratoView::ListLinContratoView ( QWidget *parent ) : SubForm2Bf ( parent )
{
    ...
    addSHeader ( "idlcontrato", DBCampo::DBint, DBCampo::DBPrimaryKey, BlSubFormHeader::DBNoView, _( "Idl contrato" ) );
    addSHeader ( "desclcontrato", DBCampo::DBvarchar, DBCampo::DBNotNull, BlSubFormHeader::DBNone, _( "Descripcionl contrato" ) );
    addSHeader ( "cantlcontrato", DBCampo::DBnumeric, DBCampo::DBNotNull, BlSubFormHeader::DBNone, _( "Cantidadl contrato" ) );
    addSHeader ( "pvplcontrato", DBCampo::DBnumeric, DBCampo::DBNotNull, BlSubFormHeader::DBNone, _( "PVPl contrato" ) );
    addSHeader ( "idcontrato", DBCampo::DBint, DBCampo::DBNotNull, BlSubFormHeader::DBNoView, _( "Id contrato" ) );
    addSHeader ( "ordenlcontrato", DBCampo::DBint, DBCampo::DBNotNull, BlSubFormHeader::DBNoView, _( "Orden" ) );
    setinsercion ( TRUE );
