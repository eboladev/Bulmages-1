...
#include "bfform.h"
#include "pdefs_pluginbf_bloqueofechas.h"
...
class PLUGINBC_BLOQUEOFECHAS_EXPORT BcBloqueaFechaView : public BfForm, public Ui_BcBloqueaFechaBase
{
    Q_OBJECT
...
public:
    BcBloqueaFechaView ( BfCompany *emp, QWidget * parent = 0 );
    ~BcBloqueaFechaView();
