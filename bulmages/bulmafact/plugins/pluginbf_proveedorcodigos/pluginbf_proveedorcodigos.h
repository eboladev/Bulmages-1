...
#ifndef PLUGINBF_PROVEEDORCODIGOS_H
#define PLUGINBF_PROVEEDORCODIGOS_H
...
#include "bfsubform.h"
#include "pdefs_pluginbf_proveedorcodigos.h"
...
// MILISEG_REFRESCO_ESTAD_PROVEEDORCODIGOS. Para una instalación
...
#define MILISEG_REFRESCO_ESTAD_PROVEEDORCODIGOS 60000 // 1 min


extern "C" PLUGINBF_PROVEEDORCODIGOS_EXPORT int entryPoint ( BfBulmaFact * );
extern "C" PLUGINBF_PROVEEDORCODIGOS_EXPORT int ArticuloView_ArticuloView ( ArticuloView * );
extern "C" PLUGINBF_PROVEEDORCODIGOS_EXPORT int ArticuloView_load ( ArticuloView * );
extern "C" PLUGINBF_PROVEEDORCODIGOS_EXPORT int ArticuloView_guardar_post ( ArticuloView * );

extern "C" PLUGINBF_PROVEEDORCODIGOS_EXPORT int Busqueda_on_m_inputBusqueda_textChanged ( BlSearchWidget * );
/*
...
*/
extern "C" PLUGINBF_PROVEEDORCODIGOS_EXPORT int BlSubForm_editFinished(BlSubForm *);
extern "C" PLUGINBF_PROVEEDORCODIGOS_EXPORT int BlDbCompleterComboBox_textChanged (BlDbCompleterComboBox *);
