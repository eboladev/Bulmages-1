...
BEGIN
	...
	IF FOUND THEN
		UPDATE CONFIGURACION SET valor=''0.11.1-0001'' WHERE nombre=''DBRev-Tallas-y-Colores'';
	ELSE
		INSERT INTO configuracion (nombre, valor) VALUES (''DBRev-Tallas-y-Colores'', ''0.11.1-0001'');
	END IF;
	RETURN 0;
END;
'   LANGUAGE plpgsql;
