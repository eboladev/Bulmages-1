...
AlbaranClienteListSubform::AlbaranClienteListSubform ( QWidget *parent ) : SubForm2Bf ( parent )
{
    ...
    addSHeader ( "refalbaran", DBCampo::DBint, DBCampo::DBNotNull | DBCampo::DBPrimaryKey, BlSubFormHeader::DBNoView | BlSubFormHeader::DBNoWrite, _( "Referencia de albaran" ) );
    ...
    addSHeader ( "numalbaran", DBCampo::DBint, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Numero de albaran" ) );
    addSHeader ( "descalbaran", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Descripcion" ) );
    addSHeader ( "fechaalbaran", DBCampo::DBdate, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Fecha de albaran" ) );
    ...
    addSHeader ( "descforma_pago", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Descripcion de forma de pago" ) );
    ...
    addSHeader ( "idalbaran", DBCampo::DBint, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "ID albaran" ) );
    addSHeader ( "comentalbaran", DBCampo::DBvarchar, DBCampo::DBNoSave, BlSubFormHeader::DBNone | BlSubFormHeader::DBNoWrite, _( "Comentarios del albaran" ) );
