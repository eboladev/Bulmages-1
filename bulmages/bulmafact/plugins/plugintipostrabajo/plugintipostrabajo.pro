...
unix{
    TARGET = ../../../installbulmages/plugins/plugintipostrabajo
...
FORMS =   listtipostrabajobase.ui

SOURCES = plugintipostrabajo.cpp \
          listtipostrabajoview.cpp \
	  busquedatipotrabajo.cpp

HEADERS = plugintipostrabajo.h \
	  tiptrab.h \
	  listtipostrabajoview.h \
	  busquedatipotrabajo.h
