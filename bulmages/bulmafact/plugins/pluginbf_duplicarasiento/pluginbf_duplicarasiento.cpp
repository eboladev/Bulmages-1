...
#include "pluginbf_duplicarasiento.h"
...
/**
**/
PluginBc_DuplicarAsiento::PluginBc_DuplicarAsiento(BcAsientoView * as, BfCompany *comp, QWidget *parent ) : BlMainCompanyPointer(comp), QToolButton(parent)
{
    BL_FUNC_DEBUG
...
{
    BL_FUNC_DEBUG
    DuplicarAsientoView *dupli = new DuplicarAsientoView ( (BfCompany *)mainCompany(), 0 );
...
int entryPoint ( BfBulmaFact *bcont )
{
    ...
    setlocale ( LC_ALL, "" );
    blBindTextDomain ( "pluginbf_duplicarasiento", g_confpr->value( CONF_DIR_TRADUCCION ).toLatin1().constData() );
