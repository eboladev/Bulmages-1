...
--
\echo "********* INICIADO FICHERO DE ESTRUCTURA DEL PLUGIN DE CAMAREROS *********"
...
BEGIN
	...
	IF NOT FOUND THEN
		...
		ALTER TABLE trabajador ADD COLUMN gerentetrabajador BOOLEAN DEFAULT FALSE;
	END IF;
...
\echo "Agregamos los campos password, admin y gerente a la tabla de trabajador"
