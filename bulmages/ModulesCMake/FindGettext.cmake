  ...
  if (HAVE_LIBINTL_H)
	...
	if (WIN32)
	 	...
	 	FIND_PATH(GETTEXT_INCLUDE_DIR
			NAMES libintl.h
			PATHS "[HKEY_LOCAL_MACHINE\\SOFTWARE\\GnuWin32\\GetText;InstallPath]/include"
		)

		FIND_LIBRARY(GETTEXT_LIBRARIES
			NAMES intl3
			PATHS "[HKEY_LOCAL_MACHINE\\SOFTWARE\\GnuWin32\\GetText;InstallPath]/bin"
		)

		if (GETTEXT_INCLUDE_DIR AND GETTEXT_LIBRARIES)
			set(GETTEXT_FOUND TRUE)
		endif (GETTEXT_INCLUDE_DIR AND GETTEXT_LIBRARIES)
